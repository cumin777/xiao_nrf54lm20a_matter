	...
	{                                                                                                                                                    \
		...
		{ ZAP_EMPTY_DEFAULT(), 0x00000000, 0, ZAP_TYPE(ARRAY),                                                                                       \
		  ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) | ZAP_ATTRIBUTE_MASK(READABLE) }, /* DeviceTypeList */                                                \
			...
			{ ZAP_SIMPLE_DEFAULT(10), 0x00000012, 2, ZAP_TYPE(INT16U),                                                                           \
			  ZAP_ATTRIBUTE_MASK(READABLE) }, /* NumberOfPINUsersSupported */                                                                    \
			{ ZAP_SIMPLE_DEFAULT(0), 0x00000014, 1, ZAP_TYPE(INT8U), ZAP_ATTRIBUTE_MASK(READABLE) }, /* NumberOfWeekDaySchedulesSupportedPerUser \
														  */                                         \
			{ ZAP_SIMPLE_DEFAULT(0), 0x00000015, 1, ZAP_TYPE(INT8U), ZAP_ATTRIBUTE_MASK(READABLE) }, /* NumberOfYearDaySchedulesSupportedPerUser \
														  */                                         \
			{ ZAP_SIMPLE_DEFAULT(0), 0x00000016, 1, ZAP_TYPE(INT8U), ZAP_ATTRIBUTE_MASK(READABLE) }, /* NumberOfHolidaySchedulesSupported        \
														  */                                         \
			...
			{ ZAP_SIMPLE_DEFAULT(6), 0x00000018, 1, ZAP_TYPE(INT8U), ZAP_ATTRIBUTE_MASK(READABLE) }, /* MinPINCodeLength                         \
														  */                                         \
			{ ZAP_SIMPLE_DEFAULT(1), 0x0000001B, 1, ZAP_TYPE(BITMAP8),                                                                           \
			  ZAP_ATTRIBUTE_MASK(READABLE) }, /* CredentialRulesSupport */                                                                       \
			{ ZAP_SIMPLE_DEFAULT(5), 0x0000001C, 1, ZAP_TYPE(INT8U), ZAP_ATTRIBUTE_MASK(READABLE) }, /* NumberOfCredentialsSupportedPerUser      \
														  */                                         \
			...
			{ ZAP_SIMPLE_DEFAULT(0), 0x00000033, 1, ZAP_TYPE(BOOLEAN),                                                                           \
			  ZAP_ATTRIBUTE_MASK(WRITABLE) | ZAP_ATTRIBUTE_MASK(READABLE) }, /* RequirePINforRemoteOperation                                     \
											  */                                                                 \
			{ ZAP_SIMPLE_DEFAULT(0xD91), 0x0000FFFC, 4, ZAP_TYPE(BITMAP32),                                                                      \
			  ZAP_ATTRIBUTE_MASK(READABLE) }, /* FeatureMap */                                                                                   \
			{ ZAP_SIMPLE_DEFAULT(8), 0x0000FFFD, 2, ZAP_TYPE(INT16U),                                                                            \
			  ZAP_ATTRIBUTE_MASK(READABLE) }, /* ClusterRevision */                                                                              \
	}
...
#define GENERATED_ENDPOINT_TYPES                                                                                       \
	{                                                                                                              \
		{ ZAP_CLUSTER_INDEX(0), 18, 32 }, { ZAP_CLUSTER_INDEX(18), 3, 37 },                                    \
	}
