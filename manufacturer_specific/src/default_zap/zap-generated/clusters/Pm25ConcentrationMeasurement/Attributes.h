			...
			namespace Attributes
			{
				...
				namespace MeasuredValue
				{
					struct TypeInfo {
						...
						{
							return Clusters::Pm25ConcentrationMeasurement::Id;
						}
				...
				{
					struct TypeInfo {
						using Type = chip::app::Clusters::Pm25ConcentrationMeasurement::
							MeasurementUnitEnum;
				...
				namespace MeasurementMedium
				{
					struct TypeInfo {
						...
						using DecodableType = chip::app::Clusters::
							Pm25ConcentrationMeasurement::MeasurementMediumEnum;
						using DecodableArgType = chip::app::Clusters::
							Pm25ConcentrationMeasurement::MeasurementMediumEnum;
				...
				namespace LevelValue
				{
					struct TypeInfo {
						using Type =
							chip::app::Clusters::Pm25ConcentrationMeasurement::LevelValueEnum;
						using DecodableType =
							chip::app::Clusters::Pm25ConcentrationMeasurement::LevelValueEnum;
				...
				struct TypeInfo {
					struct DecodableType {
						...
						Attributes::MeasurementUnit::TypeInfo::DecodableType measurementUnit =
							static_cast<chip::app::Clusters::Pm25ConcentrationMeasurement::
