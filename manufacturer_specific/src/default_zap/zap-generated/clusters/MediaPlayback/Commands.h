			...
			namespace Commands
			{
				namespace Play
				{
					...
					public:
						...
						using ResponseType = Clusters::MediaPlayback::Commands::
							PlaybackResponse::DecodableType;
				...
				namespace FastForward
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::FastForward::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::MediaPlayback::Id;
				...
				namespace SkipForward
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::SkipForward::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::MediaPlayback::Id;
				...
				namespace SkipBackward
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::SkipBackward::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::MediaPlayback::Id;
				...
				namespace PlaybackResponse
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::PlaybackResponse::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::MediaPlayback::Id;
				...
				namespace ActivateAudioTrack
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::ActivateAudioTrack::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::MediaPlayback::Id;
				...
				namespace ActivateTextTrack
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::ActivateTextTrack::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::MediaPlayback::Id;
				...
				namespace DeactivateTextTrack
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::DeactivateTextTrack::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::MediaPlayback::Id;
