	...
	namespace Clusters
	{
		namespace ClosureDimension
		{
			...
			namespace Attributes
			{
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(Unit::Id, BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace Unit
				namespace UnitRange
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(UnitRange::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace UnitRange
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(TranslationDirection::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace TranslationDirection
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(RotationAxis::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace RotationAxis
				namespace Overflow
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(ModulationType::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace ModulationType
