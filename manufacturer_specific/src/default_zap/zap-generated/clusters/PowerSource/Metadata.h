			...
			namespace Attributes
			{
				...
				namespace Status
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(Status::Id, BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace Status
				namespace Order
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(Order::Id, BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace Order
				namespace Description
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(Description::Id,
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(WiredAssessedInputVoltage::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace WiredAssessedInputVoltage
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(WiredAssessedInputFrequency::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace WiredAssessedInputFrequency
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(WiredCurrentType::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace WiredCurrentType
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(WiredAssessedCurrent::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace WiredAssessedCurrent
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(WiredNominalVoltage::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace WiredNominalVoltage
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(WiredMaximumCurrent::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace WiredMaximumCurrent
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(WiredPresent::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace WiredPresent
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(BatPercentRemaining::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace BatPercentRemaining
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(BatTimeRemaining::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace BatTimeRemaining
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(BatChargeLevel::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace BatChargeLevel
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(BatReplacementNeeded::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace BatReplacementNeeded
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(BatReplaceability::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace BatReplaceability
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(BatReplacementDescription::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace BatReplacementDescription
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(BatCommonDesignation::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace BatCommonDesignation
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(BatANSIDesignation::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace BatANSIDesignation
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(BatIECDesignation::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace BatIECDesignation
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(BatApprovedChemistry::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace BatApprovedChemistry
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(BatChargeState::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace BatChargeState
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(BatTimeToFullCharge::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace BatTimeToFullCharge
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(BatFunctionalWhileCharging::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace BatFunctionalWhileCharging
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(BatChargingCurrent::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace BatChargingCurrent
