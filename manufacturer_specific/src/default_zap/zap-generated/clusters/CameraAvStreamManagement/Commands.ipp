		...
		namespace CameraAvStreamManagement
		{
			namespace Commands
			{
				...
				namespace SetStreamPriorities
				{
					...
					{
						DataModel::WrappedStructEncoder encoder{ aWriter, aTag };
						encoder.Encode(to_underlying(Fields::kStreamPriorities),
							       streamPriorities);
						return encoder.Finalize();
					}
				...
				namespace CaptureSnapshot
				{
					...
					CHIP_ERROR Type::Encode(TLV::TLVWriter &aWriter, TLV::Tag aTag) const
					{
						...
						encoder.Encode(to_underlying(Fields::kSnapshotStreamID),
							       snapshotStreamID);
						encoder.Encode(to_underlying(Fields::kRequestedResolution),
							       requestedResolution);
						return encoder.Finalize();
					}
						...
						while (true) {
							...
							if (__context_tag == to_underlying(Fields::kSnapshotStreamID)) {
								err = DataModel::Decode(reader, snapshotStreamID);
								   ...
								   to_underlying(Fields::kRequestedResolution)) {
