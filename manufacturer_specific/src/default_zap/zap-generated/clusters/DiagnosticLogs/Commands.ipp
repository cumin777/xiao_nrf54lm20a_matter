			...
			namespace Commands
			{
				namespace RetrieveLogsRequest
				{
					...
					CHIP_ERROR Type::Encode(TLV::TLVWriter &aWriter, TLV::Tag aTag) const
					{
						...
						encoder.Encode(to_underlying(Fields::kRequestedProtocol),
							       requestedProtocol);
						encoder.Encode(to_underlying(Fields::kTransferFileDesignator),
						...
						while (true) {
							...
							if (__context_tag == to_underlying(Fields::kIntent)) {
								err = DataModel::Decode(reader, intent);
								   ...
								   to_underlying(Fields::kRequestedProtocol)) {
								err = DataModel::Decode(reader, requestedProtocol);
							} else if (__context_tag ==
								   to_underlying(Fields::kTransferFileDesignator)) {
						...
						while (true) {
							...
							if (__context_tag == to_underlying(Fields::kStatus)) {
								err = DataModel::Decode(reader, status);
								   ...
								   to_underlying(Fields::kLogContent)) {
								err = DataModel::Decode(reader, logContent);
							} else if (__context_tag ==
								   to_underlying(Fields::kUTCTimeStamp)) {
								err = DataModel::Decode(reader, UTCTimeStamp);
							} else if (__context_tag ==
								   to_underlying(Fields::kTimeSinceBoot)) {
