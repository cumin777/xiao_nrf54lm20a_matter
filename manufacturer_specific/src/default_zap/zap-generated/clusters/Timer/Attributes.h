			...
			namespace Attributes
			{
				...
				namespace SetTime
				{
					struct TypeInfo {
						...
						{
							return Clusters::Timer::Id;
						}
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::SetTime::Id;
						}
				...
				namespace TimeRemaining
				{
					struct TypeInfo {
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::TimeRemaining::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace TimeRemaining
				namespace TimerState
				{
					struct TypeInfo {
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::TimerState::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace TimerState
				...
				struct TypeInfo {
					struct DecodableType {
						...
						Attributes::SetTime::TypeInfo::DecodableType setTime =
							static_cast<uint32_t>(0);
						Attributes::TimeRemaining::TypeInfo::DecodableType timeRemaining =
							static_cast<uint32_t>(0);
						Attributes::TimerState::TypeInfo::DecodableType timerState =
							static_cast<chip::app::Clusters::Timer::TimerStatusEnum>(0);
