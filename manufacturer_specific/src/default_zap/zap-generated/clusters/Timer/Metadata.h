	...
	namespace Clusters
	{
		namespace Timer
		{
			...
			namespace Attributes
			{
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(TimeRemaining::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace TimeRemaining
			...
			namespace Commands
			{
				...
				namespace SetTimer
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(SetTimer::Id, BitFlags<DataModel::CommandQualityFlags>(),
							       Access::Privilege::kOperate);
				} // namespace SetTimer
				namespace ResetTimer
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(ResetTimer::Id,
				...
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(AddTime::Id, BitFlags<DataModel::CommandQualityFlags>(),
							       Access::Privilege::kOperate);
				} // namespace AddTime
				namespace ReduceTime
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(ReduceTime::Id,
							       BitFlags<DataModel::CommandQualityFlags>(),
							       Access::Privilege::kOperate);
				} // namespace ReduceTime
