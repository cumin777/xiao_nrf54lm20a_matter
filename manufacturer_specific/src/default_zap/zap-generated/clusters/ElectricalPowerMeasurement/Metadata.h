	...
	namespace Clusters
	{
		namespace ElectricalPowerMeasurement
		{
			...
			namespace Attributes
			{
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(NumberOfMeasurementTypes::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace NumberOfMeasurementTypes
				namespace Accuracy
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(ActiveCurrent::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace ActiveCurrent
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(ReactiveCurrent::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace ReactiveCurrent
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(ApparentCurrent::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace ApparentCurrent
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(ReactivePower::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace ReactivePower
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(ApparentPower::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace ApparentPower
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(NeutralCurrent::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace NeutralCurrent
