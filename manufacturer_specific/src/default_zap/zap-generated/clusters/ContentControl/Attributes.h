			...
			namespace Attributes
			{
				...
				namespace OnDemandRatings
				{
					struct TypeInfo {
						using Type = chip::app::DataModel::List<
							const chip::app::Clusters::ContentControl::Structs::
								RatingNameStruct::Type>;
						using DecodableType = chip::app::DataModel::DecodableList<
							chip::app::Clusters::ContentControl::Structs::RatingNameStruct::
								DecodableType>;
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::OnDemandRatings::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace OnDemandRatings
				namespace OnDemandRatingThreshold
				{
					struct TypeInfo {
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::OnDemandRatingThreshold::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
				...
				namespace ScheduledContentRatings
				{
					struct TypeInfo {
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::ScheduledContentRatings::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace ScheduledContentRatings
				namespace ScheduledContentRatingThreshold
				{
					struct TypeInfo {
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::ScheduledContentRatingThreshold::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
						static constexpr size_t MaxLength() { return 8; }
					};
				...
				namespace ScreenDailyTime
				{
					struct TypeInfo {
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::ScreenDailyTime::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace ScreenDailyTime
				namespace RemainingScreenTime
				{
					struct TypeInfo {
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::RemainingScreenTime::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace RemainingScreenTime
				namespace BlockUnrated
				{
					struct TypeInfo {
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::BlockUnrated::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace BlockUnrated
				namespace BlockChannelList
				{
					struct TypeInfo {
						...
						using DecodableType = chip::app::DataModel::DecodableList<
							chip::app::Clusters::ContentControl::Structs::
								BlockChannelStruct::DecodableType>;
						using DecodableArgType = const chip::app::DataModel::DecodableList<
							chip::app::Clusters::ContentControl::Structs::
								BlockChannelStruct::DecodableType> &;
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::BlockChannelList::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace BlockChannelList
					...
					struct TypeInfo {
						using Type = chip::app::DataModel::List<
							const chip::app::Clusters::ContentControl::Structs::
								AppInfoStruct::Type>;
						using DecodableType = chip::app::DataModel::DecodableList<
							chip::app::Clusters::ContentControl::Structs::AppInfoStruct::
								DecodableType>;
						using DecodableArgType = const chip::app::DataModel::DecodableList<
							chip::app::Clusters::ContentControl::Structs::AppInfoStruct::
								DecodableType> &;
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::BlockApplicationList::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace BlockApplicationList
				namespace BlockContentTimeWindow
				{
					struct TypeInfo {
						...
						using DecodableType = chip::app::DataModel::DecodableList<
							chip::app::Clusters::ContentControl::Structs::TimeWindowStruct::
								DecodableType>;
						using DecodableArgType = const chip::app::DataModel::DecodableList<
							chip::app::Clusters::ContentControl::Structs::TimeWindowStruct::
								DecodableType> &;
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::BlockContentTimeWindow::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace BlockContentTimeWindow
				...
				struct TypeInfo {
					struct DecodableType {
						...
						Attributes::Enabled::TypeInfo::DecodableType enabled =
							static_cast<bool>(0);
						Attributes::OnDemandRatings::TypeInfo::DecodableType onDemandRatings;
						Attributes::OnDemandRatingThreshold::TypeInfo::DecodableType
							onDemandRatingThreshold;
						Attributes::ScheduledContentRatings::TypeInfo::DecodableType
							scheduledContentRatings;
						Attributes::ScheduledContentRatingThreshold::TypeInfo::DecodableType
							scheduledContentRatingThreshold;
						Attributes::ScreenDailyTime::TypeInfo::DecodableType screenDailyTime =
							static_cast<uint32_t>(0);
						Attributes::RemainingScreenTime::TypeInfo::DecodableType
							remainingScreenTime = static_cast<uint32_t>(0);
						Attributes::BlockUnrated::TypeInfo::DecodableType blockUnrated =
							static_cast<bool>(0);
						Attributes::BlockChannelList::TypeInfo::DecodableType blockChannelList;
						Attributes::BlockApplicationList::TypeInfo::DecodableType
							blockApplicationList;
						Attributes::BlockContentTimeWindow::TypeInfo::DecodableType
