	...
	namespace Clusters
	{
		namespace ContentControl
		{
			...
			namespace Attributes
			{
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(OnDemandRatingThreshold::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace OnDemandRatingThreshold
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(ScheduledContentRatingThreshold::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace ScheduledContentRatingThreshold
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(ScreenDailyTime::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace ScreenDailyTime
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(RemainingScreenTime::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace RemainingScreenTime
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(BlockUnrated::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace BlockUnrated
			...
			namespace Commands
			{
				...
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(AddBonusTime::Id,
							       BitFlags<DataModel::CommandQualityFlags>(),
				...
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(SetScreenDailyTime::Id,
							       BitFlags<DataModel::CommandQualityFlags>(),
							       Access::Privilege::kManage);
				} // namespace SetScreenDailyTime
				...
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(BlockUnratedContent::Id,
							       BitFlags<DataModel::CommandQualityFlags>(),
							       Access::Privilege::kManage);
				} // namespace BlockUnratedContent
				...
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(UnblockUnratedContent::Id,
							       BitFlags<DataModel::CommandQualityFlags>(),
							       Access::Privilege::kManage);
				} // namespace UnblockUnratedContent
				...
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(SetOnDemandRatingThreshold::Id,
							       BitFlags<DataModel::CommandQualityFlags>(),
							       Access::Privilege::kManage);
				} // namespace SetOnDemandRatingThreshold
				...
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(SetScheduledContentRatingThreshold::Id,
							       BitFlags<DataModel::CommandQualityFlags>(),
							       Access::Privilege::kManage);
				} // namespace SetScheduledContentRatingThreshold
				...
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(AddBlockChannels::Id,
							       BitFlags<DataModel::CommandQualityFlags>(),
							       Access::Privilege::kManage);
				} // namespace AddBlockChannels
				...
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(RemoveBlockChannels::Id,
							       BitFlags<DataModel::CommandQualityFlags>(),
							       Access::Privilege::kManage);
				} // namespace RemoveBlockChannels
				...
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(AddBlockApplications::Id,
							       BitFlags<DataModel::CommandQualityFlags>(),
							       Access::Privilege::kManage);
				} // namespace AddBlockApplications
				...
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(RemoveBlockApplications::Id,
							       BitFlags<DataModel::CommandQualityFlags>(),
							       Access::Privilege::kManage);
				} // namespace RemoveBlockApplications
				...
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(SetBlockContentTimeWindow::Id,
							       BitFlags<DataModel::CommandQualityFlags>(),
							       Access::Privilege::kManage);
				} // namespace SetBlockContentTimeWindow
				...
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(RemoveBlockContentTimeWindow::Id,
							       BitFlags<DataModel::CommandQualityFlags>(),
							       Access::Privilege::kManage);
				} // namespace RemoveBlockContentTimeWindow
