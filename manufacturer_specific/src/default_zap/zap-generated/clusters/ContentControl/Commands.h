			...
			namespace Commands
			{
				...
				namespace ResetPINResponse
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::ResetPINResponse::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::ContentControl::Id;
				...
				namespace AddBonusTime
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::AddBonusTime::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::ContentControl::Id;
				...
				namespace SetScreenDailyTime
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::SetScreenDailyTime::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::ContentControl::Id;
				...
				namespace BlockUnratedContent
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::BlockUnratedContent::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::ContentControl::Id;
				...
				namespace UnblockUnratedContent
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::UnblockUnratedContent::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::ContentControl::Id;
				...
				namespace SetOnDemandRatingThreshold
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::SetOnDemandRatingThreshold::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::ContentControl::Id;
				...
				namespace SetScheduledContentRatingThreshold
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::SetScheduledContentRatingThreshold::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::ContentControl::Id;
