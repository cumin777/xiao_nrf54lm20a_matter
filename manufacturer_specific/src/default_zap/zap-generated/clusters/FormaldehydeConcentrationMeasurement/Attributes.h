			...
			namespace Attributes
			{
				...
				namespace MeasuredValue
				{
					struct TypeInfo {
						...
						{
							return Clusters::FormaldehydeConcentrationMeasurement::Id;
						}
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::MeasuredValue::Id;
						}
				...
				namespace MinMeasuredValue
				{
					struct TypeInfo {
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::MinMeasuredValue::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace MinMeasuredValue
				namespace MaxMeasuredValue
				{
					struct TypeInfo {
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::MaxMeasuredValue::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace MaxMeasuredValue
				namespace PeakMeasuredValue
				{
					struct TypeInfo {
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::PeakMeasuredValue::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace PeakMeasuredValue
				namespace PeakMeasuredValueWindow
				{
					struct TypeInfo {
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::PeakMeasuredValueWindow::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace PeakMeasuredValueWindow
				namespace AverageMeasuredValue
				{
					struct TypeInfo {
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::AverageMeasuredValue::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace AverageMeasuredValue
				namespace AverageMeasuredValueWindow
				{
					struct TypeInfo {
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::AverageMeasuredValueWindow::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace AverageMeasuredValueWindow
				namespace Uncertainty
				{
					struct TypeInfo {
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::Uncertainty::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace Uncertainty
				...
				{
					struct TypeInfo {
						using Type = chip::app::Clusters::FormaldehydeConcentrationMeasurement::
							MeasurementUnitEnum;
						using DecodableType = chip::app::Clusters::
							FormaldehydeConcentrationMeasurement::MeasurementUnitEnum;
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::MeasurementUnit::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace MeasurementUnit
				namespace MeasurementMedium
				{
					struct TypeInfo {
						...
						using DecodableType = chip::app::Clusters::
							FormaldehydeConcentrationMeasurement::MeasurementMediumEnum;
						using DecodableArgType = chip::app::Clusters::
							FormaldehydeConcentrationMeasurement::MeasurementMediumEnum;
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::MeasurementMedium::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace MeasurementMedium
				namespace LevelValue
				{
					struct TypeInfo {
						using Type = chip::app::Clusters::FormaldehydeConcentrationMeasurement::
							LevelValueEnum;
						using DecodableType = chip::app::Clusters::
							FormaldehydeConcentrationMeasurement::LevelValueEnum;
						using DecodableArgType = chip::app::Clusters::
							FormaldehydeConcentrationMeasurement::LevelValueEnum;
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::LevelValue::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace LevelValue
				...
				struct TypeInfo {
					struct DecodableType {
						...
						Attributes::PeakMeasuredValueWindow::TypeInfo::DecodableType
							peakMeasuredValueWindow = static_cast<uint32_t>(0);
						Attributes::AverageMeasuredValue::TypeInfo::DecodableType
							averageMeasuredValue;
						Attributes::AverageMeasuredValueWindow::TypeInfo::DecodableType
							averageMeasuredValueWindow = static_cast<uint32_t>(0);
						Attributes::Uncertainty::TypeInfo::DecodableType uncertainty =
							static_cast<float>(0);
						Attributes::MeasurementUnit::TypeInfo::DecodableType measurementUnit =
							static_cast<
								chip::app::Clusters::FormaldehydeConcentrationMeasurement::
									MeasurementUnitEnum>(0);
						Attributes::MeasurementMedium::TypeInfo::DecodableType
							measurementMedium = static_cast<
								chip::app::Clusters::FormaldehydeConcentrationMeasurement::
									MeasurementMediumEnum>(0);
						Attributes::LevelValue::TypeInfo::DecodableType levelValue = static_cast<
							chip::app::Clusters::FormaldehydeConcentrationMeasurement::
								LevelValueEnum>(0);
