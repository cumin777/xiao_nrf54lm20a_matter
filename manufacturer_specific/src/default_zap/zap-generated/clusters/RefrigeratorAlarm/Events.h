			...
			namespace Events
			{
				namespace Notify
				{
					...
					public:
						...
						{
							return Clusters::RefrigeratorAlarm::Id;
						}
						static constexpr bool kIsFabricScoped = false;

						chip::BitMask<AlarmBitmap> active =
							static_cast<chip::BitMask<AlarmBitmap>>(0);
						chip::BitMask<AlarmBitmap> inactive =
							static_cast<chip::BitMask<AlarmBitmap>>(0);
						chip::BitMask<AlarmBitmap> state =
							static_cast<chip::BitMask<AlarmBitmap>>(0);
						chip::BitMask<AlarmBitmap> mask =
							static_cast<chip::BitMask<AlarmBitmap>>(0);
