			...
			namespace Attributes
			{
				...
				namespace MeasuredValue
				{
					struct TypeInfo {
						...
						{
							return Clusters::CarbonDioxideConcentrationMeasurement::Id;
						}
				...
				namespace MeasurementUnit
				{
					struct TypeInfo {
						using Type = chip::app::Clusters::
							CarbonDioxideConcentrationMeasurement::MeasurementUnitEnum;
				...
				namespace MeasurementMedium
				{
					struct TypeInfo {
						using Type = chip::app::Clusters::
							CarbonDioxideConcentrationMeasurement::MeasurementMediumEnum;
						using DecodableType = chip::app::Clusters::
							CarbonDioxideConcentrationMeasurement::MeasurementMediumEnum;
						using DecodableArgType = chip::app::Clusters::
							CarbonDioxideConcentrationMeasurement::MeasurementMediumEnum;
				...
				namespace LevelValue
				{
					struct TypeInfo {
						using Type = chip::app::Clusters::
							CarbonDioxideConcentrationMeasurement::LevelValueEnum;
						using DecodableType = chip::app::Clusters::
							CarbonDioxideConcentrationMeasurement::LevelValueEnum;
						using DecodableArgType = chip::app::Clusters::
							CarbonDioxideConcentrationMeasurement::LevelValueEnum;
				...
				struct TypeInfo {
					struct DecodableType {
						...
						Attributes::LevelValue::TypeInfo::DecodableType levelValue = static_cast<
							chip::app::Clusters::CarbonDioxideConcentrationMeasurement::
								LevelValueEnum>(0);
