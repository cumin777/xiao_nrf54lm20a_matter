			...
			namespace Commands
			{
				namespace SelectAreas
				{
					...
					public:
						...
						{
							return Commands::SelectAreas::Id;
						}
						...
						using ResponseType = Clusters::ServiceArea::Commands::
							SelectAreasResponse::DecodableType;
				...
				namespace SelectAreasResponse
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::SelectAreasResponse::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::ServiceArea::Id;
				...
				namespace SkipArea
				{
					...
					public:
						...
						using ResponseType =
							Clusters::ServiceArea::Commands::SkipAreaResponse::DecodableType;
				...
				namespace SkipAreaResponse
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::SkipAreaResponse::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::ServiceArea::Id;
