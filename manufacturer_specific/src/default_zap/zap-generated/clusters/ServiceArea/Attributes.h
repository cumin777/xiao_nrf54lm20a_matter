		...
		namespace ServiceArea
		{
			namespace Attributes
			{
				...
				namespace SupportedAreas
				{
					struct TypeInfo {
						using Type = chip::app::DataModel::List<
							const chip::app::Clusters::ServiceArea::Structs::AreaStruct::Type>;
						using DecodableType = chip::app::DataModel::DecodableList<
							chip::app::Clusters::ServiceArea::Structs::AreaStruct::
								DecodableType>;
						...
						{
							return Clusters::ServiceArea::Id;
						}
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::SupportedAreas::Id;
						}
				...
				namespace SupportedMaps
				{
					struct TypeInfo {
						using Type = chip::app::DataModel::List<
							const chip::app::Clusters::ServiceArea::Structs::MapStruct::Type>;
						using DecodableType = chip::app::DataModel::DecodableList<
							chip::app::Clusters::ServiceArea::Structs::MapStruct::
								DecodableType>;
						using DecodableArgType = const chip::app::DataModel::DecodableList<
							chip::app::Clusters::ServiceArea::Structs::MapStruct::
								DecodableType> &;
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::SupportedMaps::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace SupportedMaps
				namespace SelectedAreas
				{
					struct TypeInfo {
						...
						using DecodableArgType =
							const chip::app::DataModel::DecodableList<uint32_t> &;
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::SelectedAreas::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace SelectedAreas
				namespace CurrentArea
				{
					struct TypeInfo {
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::CurrentArea::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace CurrentArea
				namespace EstimatedEndTime
				{
					struct TypeInfo {
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::EstimatedEndTime::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace EstimatedEndTime
				namespace Progress
				{
					struct TypeInfo {
						using Type = chip::app::DataModel::List<
							const chip::app::Clusters::ServiceArea::Structs::
								ProgressStruct::Type>;
						using DecodableType = chip::app::DataModel::DecodableList<
							chip::app::Clusters::ServiceArea::Structs::ProgressStruct::
								DecodableType>;
						using DecodableArgType = const chip::app::DataModel::DecodableList<
							chip::app::Clusters::ServiceArea::Structs::ProgressStruct::
								DecodableType> &;
