...
namespace app
{
	namespace DataModel
	{
		...
		template <> struct ClusterMetadataProvider<DataModel::AttributeEntry, Clusters::ServiceArea::Id> {
		...
		template <> struct ClusterMetadataProvider<DataModel::AcceptedCommandEntry, Clusters::ServiceArea::Id> {
