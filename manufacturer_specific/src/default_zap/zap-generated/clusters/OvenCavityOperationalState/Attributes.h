			...
			namespace Attributes
			{
				...
				namespace PhaseList
				{
					struct TypeInfo {
						using Type = chip::app::DataModel::Nullable<
							chip::app::DataModel::List<const chip::CharSpan>>;
						using DecodableType = chip::app::DataModel::Nullable<
							chip::app::DataModel::DecodableList<chip::CharSpan>>;
						using DecodableArgType = const chip::app::DataModel::Nullable<
							chip::app::DataModel::DecodableList<chip::CharSpan>> &;

						static constexpr ClusterId GetClusterId()
						{
							return Clusters::OvenCavityOperationalState::Id;
						}
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::PhaseList::Id;
						}
				...
				namespace CurrentPhase
				{
					struct TypeInfo {
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::CurrentPhase::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace CurrentPhase
				namespace CountdownTime
				{
					struct TypeInfo {
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::CountdownTime::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace CountdownTime
				namespace OperationalStateList
				{
					struct TypeInfo {
						using Type = chip::app::DataModel::List<
							const chip::app::Clusters::OvenCavityOperationalState::Structs::
								OperationalStateStruct::Type>;
						using DecodableType = chip::app::DataModel::DecodableList<
							chip::app::Clusters::OvenCavityOperationalState::Structs::
								OperationalStateStruct::DecodableType>;
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::OperationalStateList::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace OperationalStateList
				...
				{
					struct TypeInfo {
						using Type = chip::app::Clusters::OvenCavityOperationalState::
							OperationalStateEnum;
						using DecodableType = chip::app::Clusters::OvenCavityOperationalState::
							OperationalStateEnum;
						using DecodableArgType = chip::app::Clusters::
							OvenCavityOperationalState::OperationalStateEnum;
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::OperationalState::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace OperationalState
				...
				{
					struct TypeInfo {
						using Type = chip::app::Clusters::OvenCavityOperationalState::Structs::
							ErrorStateStruct::Type;
						using DecodableType = chip::app::Clusters::OvenCavityOperationalState::
							Structs::ErrorStateStruct::DecodableType;
						using DecodableArgType =
							const chip::app::Clusters::OvenCavityOperationalState::Structs::
								ErrorStateStruct::DecodableType &;
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::OperationalError::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace OperationalError
				...
				struct TypeInfo {
					struct DecodableType {
						...
						Attributes::OperationalStateList::TypeInfo::DecodableType
							operationalStateList;
						Attributes::OperationalState::TypeInfo::DecodableType operationalState =
							static_cast<chip::app::Clusters::OvenCavityOperationalState::
									    OperationalStateEnum>(0);
