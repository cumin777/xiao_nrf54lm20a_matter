...
namespace app
{
	namespace DataModel
	{
		...
		template <> struct ClusterMetadataProvider<DataModel::AttributeEntry, Clusters::FanControl::Id> {
		...
		template <> struct ClusterMetadataProvider<DataModel::AcceptedCommandEntry, Clusters::FanControl::Id> {
