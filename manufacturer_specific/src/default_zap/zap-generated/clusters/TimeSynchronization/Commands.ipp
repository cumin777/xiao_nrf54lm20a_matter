		...
		namespace TimeSynchronization
		{
			namespace Commands
			{
						...
						while (true) {
							...
							if (__context_tag == to_underlying(Fields::kUTCTime)) {
								err = DataModel::Decode(reader, UTCTime);
								   ...
								   to_underlying(Fields::kGranularity)) {
								err = DataModel::Decode(reader, granularity);
							} else if (__context_tag ==
								   to_underlying(Fields::kTimeSource)) {
				...
				namespace SetTrustedTimeSource
				{
					...
					{
						DataModel::WrappedStructEncoder encoder{ aWriter, aTag };
						encoder.Encode(to_underlying(Fields::kTrustedTimeSource),
							       trustedTimeSource);
						return encoder.Finalize();
					}
									 ...
									 FabricIndex aAccessingFabricIndex)
					{
						...
						while (true) {
							...
							if (__context_tag ==
							    to_underlying(Fields::kTrustedTimeSource)) {
				...
				namespace SetTimeZoneResponse
				{
					...
					{
						DataModel::WrappedStructEncoder encoder{ aWriter, aTag };
						encoder.Encode(to_underlying(Fields::kDSTOffsetRequired),
							       DSTOffsetRequired);
						return encoder.Finalize();
					}
					...
					CHIP_ERROR DecodableType::Decode(TLV::TLVReader &reader)
					{
						...
						while (true) {
							...
							if (__context_tag ==
							    to_underlying(Fields::kDSTOffsetRequired)) {
