	...
	namespace Clusters
	{
		namespace TimeSynchronization
		{
			...
			namespace Attributes
			{
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(TrustedTimeSource::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace TrustedTimeSource
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(TimeZoneDatabase::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace TimeZoneDatabase
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(NTPServerAvailable::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace NTPServerAvailable
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(TimeZoneListMaxSize::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace TimeZoneListMaxSize
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(DSTOffsetListMaxSize::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace DSTOffsetListMaxSize
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(SupportsDNSResolve::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace SupportsDNSResolve
			...
			namespace Commands
			{
				...
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(SetDSTOffset::Id,
							       BitFlags<DataModel::CommandQualityFlags>(),
							       Access::Privilege::kManage);
				} // namespace SetDSTOffset
				...
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(SetDefaultNTP::Id,
							       BitFlags<DataModel::CommandQualityFlags>(),
							       Access::Privilege::kAdminister);
				} // namespace SetDefaultNTP
