			...
			namespace Attributes
			{
				...
				namespace MeasuredValue
				{
					struct TypeInfo {
						...
						{
							return Clusters::Pm1ConcentrationMeasurement::Id;
						}
				...
				{
					struct TypeInfo {
						using Type = chip::app::Clusters::Pm1ConcentrationMeasurement::
							MeasurementUnitEnum;
						using DecodableType = chip::app::Clusters::Pm1ConcentrationMeasurement::
							MeasurementUnitEnum;
						using DecodableArgType = chip::app::Clusters::
							Pm1ConcentrationMeasurement::MeasurementUnitEnum;
				...
				namespace MeasurementMedium
				{
					struct TypeInfo {
						...
						using DecodableType = chip::app::Clusters::Pm1ConcentrationMeasurement::
							MeasurementMediumEnum;
						using DecodableArgType = chip::app::Clusters::
							Pm1ConcentrationMeasurement::MeasurementMediumEnum;
				...
				namespace LevelValue
				{
					struct TypeInfo {
						using Type =
							chip::app::Clusters::Pm1ConcentrationMeasurement::LevelValueEnum;
						using DecodableType =
							chip::app::Clusters::Pm1ConcentrationMeasurement::LevelValueEnum;
				...
				struct TypeInfo {
					struct DecodableType {
						...
						Attributes::MeasurementUnit::TypeInfo::DecodableType measurementUnit =
							static_cast<chip::app::Clusters::Pm1ConcentrationMeasurement::
