			...
			namespace Attributes
			{
				...
				namespace BorderRouterName
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(BorderRouterName::Id,
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(BorderAgentID::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace BorderAgentID
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(InterfaceEnabled::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace InterfaceEnabled
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(ActiveDatasetTimestamp::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace ActiveDatasetTimestamp
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(PendingDatasetTimestamp::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace PendingDatasetTimestamp
			...
			namespace Commands
			{
				...
				namespace GetActiveDatasetRequest
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(GetActiveDatasetRequest::Id,
				...
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(GetPendingDatasetRequest::Id,
							       BitFlags<DataModel::CommandQualityFlags>(),
							       Access::Privilege::kManage);
				} // namespace GetPendingDatasetRequest
				...
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(SetActiveDatasetRequest::Id,
							       BitFlags<DataModel::CommandQualityFlags>(
				...
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(SetPendingDatasetRequest::Id,
							       BitFlags<DataModel::CommandQualityFlags>(
								       DataModel::CommandQualityFlags::kTimed),
							       Access::Privilege::kManage);
				} // namespace SetPendingDatasetRequest
