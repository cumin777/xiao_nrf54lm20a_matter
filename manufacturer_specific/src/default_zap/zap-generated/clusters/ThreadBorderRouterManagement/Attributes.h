			...
			namespace Attributes
			{
				...
				namespace BorderRouterName
				{
					struct TypeInfo {
						...
						{
							return Clusters::ThreadBorderRouterManagement::Id;
						}
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::BorderRouterName::Id;
						}
				...
				namespace BorderAgentID
				{
					struct TypeInfo {
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::BorderAgentID::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
				...
				namespace ActiveDatasetTimestamp
				{
					struct TypeInfo {
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::ActiveDatasetTimestamp::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace ActiveDatasetTimestamp
				namespace PendingDatasetTimestamp
				{
					struct TypeInfo {
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::PendingDatasetTimestamp::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace PendingDatasetTimestamp
				...
				struct TypeInfo {
					struct DecodableType {
						...
						Attributes::InterfaceEnabled::TypeInfo::DecodableType interfaceEnabled =
							static_cast<bool>(0);
						Attributes::ActiveDatasetTimestamp::TypeInfo::DecodableType
							activeDatasetTimestamp;
						Attributes::PendingDatasetTimestamp::TypeInfo::DecodableType
