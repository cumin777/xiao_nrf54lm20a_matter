	...
	namespace Clusters
	{
		namespace PumpConfigurationAndControl
		{
			...
			namespace Attributes
			{
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(MinConstPressure::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace MinConstPressure
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(MaxConstPressure::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace MaxConstPressure
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(MinCompPressure::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace MinCompPressure
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(MaxCompPressure::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace MaxCompPressure
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(MinConstSpeed::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace MinConstSpeed
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(MaxConstSpeed::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace MaxConstSpeed
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(MinConstFlow::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace MinConstFlow
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(MaxConstFlow::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace MaxConstFlow
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(MinConstTemp::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace MinConstTemp
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(MaxConstTemp::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace MaxConstTemp
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(EffectiveOperationMode::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace EffectiveOperationMode
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(EffectiveControlMode::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace EffectiveControlMode
				namespace Capacity
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(Speed::Id, BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace Speed
				namespace LifetimeRunningHours
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(LifetimeRunningHours::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(Power::Id, BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace Power
				namespace LifetimeEnergyConsumed
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(LifetimeEnergyConsumed::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, Access::Privilege::kManage);
				} // namespace LifetimeEnergyConsumed
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(OperationMode::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, Access::Privilege::kManage);
				} // namespace OperationMode
