				...
				namespace SupportedModes
				{
					struct TypeInfo {
						using Type = chip::app::DataModel::List<
							const chip::app::Clusters::DeviceEnergyManagementMode::Structs::
								ModeOptionStruct::Type>;
						using DecodableType = chip::app::DataModel::DecodableList<
							chip::app::Clusters::DeviceEnergyManagementMode::Structs::
						...
						{
							return Clusters::DeviceEnergyManagementMode::Id;
						}
