			...
			namespace Attributes
			{
				...
				namespace SupportedDrynessLevels
				{
					struct TypeInfo {
						using Type = chip::app::DataModel::List<
							const chip::app::Clusters::LaundryDryerControls::DrynessLevelEnum>;
						...
						{
							return Clusters::LaundryDryerControls::Id;
						}
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::SupportedDrynessLevels::Id;
						}
				...
				namespace SelectedDrynessLevel
				{
					struct TypeInfo {
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::SelectedDrynessLevel::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace SelectedDrynessLevel
				...
				struct TypeInfo {
					struct DecodableType {
						...
						Attributes::SupportedDrynessLevels::TypeInfo::DecodableType
							supportedDrynessLevels;
						Attributes::SelectedDrynessLevel::TypeInfo::DecodableType
