			...
			namespace Attributes
			{
				...
				namespace CountdownTime
				{
					struct TypeInfo {
						...
						{
							return Clusters::ClosureControl::Id;
						}
				...
				namespace MainState
				{
					struct TypeInfo {
						...
						using DecodableType =
							chip::app::Clusters::ClosureControl::MainStateEnum;
						using DecodableArgType =
							chip::app::Clusters::ClosureControl::MainStateEnum;
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::MainState::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace MainState
				namespace CurrentErrorList
				{
					struct TypeInfo {
						using Type = chip::app::DataModel::List<
							const chip::app::Clusters::ClosureControl::ClosureErrorEnum>;
						using DecodableType = chip::app::DataModel::DecodableList<
							chip::app::Clusters::ClosureControl::ClosureErrorEnum>;
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::CurrentErrorList::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace CurrentErrorList
				namespace OverallCurrentState
				{
					struct TypeInfo {
						using Type = chip::app::DataModel::Nullable<
							chip::app::Clusters::ClosureControl::Structs::
								OverallCurrentStateStruct::Type>;
						using DecodableType = chip::app::DataModel::Nullable<
							chip::app::Clusters::ClosureControl::Structs::
								OverallCurrentStateStruct::DecodableType>;
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::OverallCurrentState::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace OverallCurrentState
				namespace OverallTargetState
				{
					struct TypeInfo {
						using Type = chip::app::DataModel::Nullable<
							chip::app::Clusters::ClosureControl::Structs::
								OverallTargetStateStruct::Type>;
						using DecodableType = chip::app::DataModel::Nullable<
							chip::app::Clusters::ClosureControl::Structs::
								OverallTargetStateStruct::DecodableType>;
						using DecodableArgType = const chip::app::DataModel::Nullable<
							chip::app::Clusters::ClosureControl::Structs::
								OverallTargetStateStruct::DecodableType> &;
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::OverallTargetState::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace OverallTargetState
				namespace LatchControlModes
				{
					struct TypeInfo {
						using Type = chip::BitMask<
							chip::app::Clusters::ClosureControl::LatchControlModesBitmap>;
				...
				struct TypeInfo {
					struct DecodableType {
						...
						Attributes::MainState::TypeInfo::DecodableType mainState =
							static_cast<chip::app::Clusters::ClosureControl::MainStateEnum>(
								0);
						Attributes::CurrentErrorList::TypeInfo::DecodableType currentErrorList;
						Attributes::OverallCurrentState::TypeInfo::DecodableType
							overallCurrentState;
						Attributes::OverallTargetState::TypeInfo::DecodableType
							overallTargetState;
						Attributes::LatchControlModes::TypeInfo::DecodableType latchControlModes =
							static_cast<chip::BitMask<chip::app::Clusters::ClosureControl::
