			...
			namespace Events
			{
				namespace ZoneTriggered
				{
					...
					public:
						...
						{
							return Events::ZoneTriggered::Id;
						}
						...
						ZoneEventTriggeredReasonEnum reason =
							static_cast<ZoneEventTriggeredReasonEnum>(0);
				...
				namespace ZoneStopped
				{
					...
					public:
						...
						uint16_t zone = static_cast<uint16_t>(0);
						ZoneEventStoppedReasonEnum reason =
							static_cast<ZoneEventStoppedReasonEnum>(0);
