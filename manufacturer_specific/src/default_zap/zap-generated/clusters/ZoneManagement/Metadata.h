			...
			namespace Attributes
			{
				...
				namespace MaxUserDefinedZones
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(MaxUserDefinedZones::Id,
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(SensitivityMax::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace SensitivityMax
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(TwoDCartesianMax::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace TwoDCartesianMax
			...
			namespace Commands
			{
				...
				namespace CreateTwoDCartesianZone
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(CreateTwoDCartesianZone::Id,
				...
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(UpdateTwoDCartesianZone::Id,
							       BitFlags<DataModel::CommandQualityFlags>(),
							       Access::Privilege::kManage);
				} // namespace UpdateTwoDCartesianZone
				...
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(CreateOrUpdateTrigger::Id,
							       BitFlags<DataModel::CommandQualityFlags>(),
							       Access::Privilege::kManage);
				} // namespace CreateOrUpdateTrigger
				...
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(RemoveTrigger::Id,
							       BitFlags<DataModel::CommandQualityFlags>(),
							       Access::Privilege::kManage);
				} // namespace RemoveTrigger
