			...
			namespace Commands
			{
				namespace CreateTwoDCartesianZone
				{
					...
					public:
						...
						{
							return Commands::CreateTwoDCartesianZone::Id;
						}
						...
						using ResponseType = Clusters::ZoneManagement::Commands::
							CreateTwoDCartesianZoneResponse::DecodableType;
				...
				namespace CreateTwoDCartesianZoneResponse
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::CreateTwoDCartesianZoneResponse::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::ZoneManagement::Id;
				...
				namespace UpdateTwoDCartesianZone
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::UpdateTwoDCartesianZone::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::ZoneManagement::Id;
				...
				namespace CreateOrUpdateTrigger
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::CreateOrUpdateTrigger::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::ZoneManagement::Id;
				...
				namespace RemoveTrigger
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::RemoveTrigger::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::ZoneManagement::Id;
