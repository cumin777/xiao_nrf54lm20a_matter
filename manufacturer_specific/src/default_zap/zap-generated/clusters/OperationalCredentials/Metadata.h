			...
			namespace Attributes
			{
				...
				namespace SupportedFabrics
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(SupportedFabrics::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace SupportedFabrics
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(CommissionedFabrics::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace CommissionedFabrics
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(CurrentFabricIndex::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace CurrentFabricIndex
			...
			namespace Commands
			{
				...
				namespace AttestationRequest
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(AttestationRequest::Id,
				...
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(CertificateChainRequest::Id,
							       BitFlags<DataModel::CommandQualityFlags>(),
							       Access::Privilege::kAdminister);
				} // namespace CertificateChainRequest
				...
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(AddNOC::Id, BitFlags<DataModel::CommandQualityFlags>(),
							       Access::Privilege::kAdminister);
				} // namespace AddNOC
				namespace UpdateNOC
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(UpdateNOC::Id,
							       BitFlags<DataModel::CommandQualityFlags>(
				...
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(UpdateFabricLabel::Id,
							       BitFlags<DataModel::CommandQualityFlags>(
								       DataModel::CommandQualityFlags::kFabricScoped),
							       Access::Privilege::kAdminister);
				} // namespace UpdateFabricLabel
				...
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(RemoveFabric::Id,
							       BitFlags<DataModel::CommandQualityFlags>(),
							       Access::Privilege::kAdminister);
				} // namespace RemoveFabric
				...
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(AddTrustedRootCertificate::Id,
							       BitFlags<DataModel::CommandQualityFlags>(),
							       Access::Privilege::kAdminister);
				} // namespace AddTrustedRootCertificate
				...
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(SignVIDVerificationRequest::Id,
							       BitFlags<DataModel::CommandQualityFlags>(),
							       Access::Privilege::kAdminister);
				} // namespace SignVIDVerificationRequest
