...
namespace app
{
	namespace DataModel
	{
		...
		template <> struct ClusterMetadataProvider<DataModel::AttributeEntry, Clusters::LowPower::Id> {
		...
		template <> struct ClusterMetadataProvider<DataModel::AcceptedCommandEntry, Clusters::LowPower::Id> {
