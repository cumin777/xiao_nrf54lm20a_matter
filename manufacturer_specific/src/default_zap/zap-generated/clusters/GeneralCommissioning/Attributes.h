			...
			namespace Attributes
			{
				...
				namespace Breadcrumb
				{
					struct TypeInfo {
						...
						{
							return Attributes::Breadcrumb::Id;
						}
				...
				{
					struct TypeInfo {
						using Type = chip::app::Clusters::GeneralCommissioning::Structs::
							BasicCommissioningInfo::Type;
						using DecodableType = chip::app::Clusters::GeneralCommissioning::
							Structs::BasicCommissioningInfo::DecodableType;
						using DecodableArgType =
							const chip::app::Clusters::GeneralCommissioning::Structs::
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::BasicCommissioningInfo::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace BasicCommissioningInfo
				...
				{
					struct TypeInfo {
						using Type = chip::app::Clusters::GeneralCommissioning::
							RegulatoryLocationTypeEnum;
						using DecodableType = chip::app::Clusters::GeneralCommissioning::
							RegulatoryLocationTypeEnum;
						using DecodableArgType = chip::app::Clusters::GeneralCommissioning::
							RegulatoryLocationTypeEnum;
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::RegulatoryConfig::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace RegulatoryConfig
				namespace LocationCapability
				{
					struct TypeInfo {
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::LocationCapability::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace LocationCapability
				namespace SupportsConcurrentConnection
				{
					struct TypeInfo {
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::SupportsConcurrentConnection::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace SupportsConcurrentConnection
				namespace TCAcceptedVersion
				{
					struct TypeInfo {
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::TCAcceptedVersion::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace TCAcceptedVersion
				namespace TCMinRequiredVersion
				{
					struct TypeInfo {
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::TCMinRequiredVersion::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace TCMinRequiredVersion
				namespace TCAcknowledgements
				{
					struct TypeInfo {
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::TCAcknowledgements::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace TCAcknowledgements
				namespace TCAcknowledgementsRequired
				{
					struct TypeInfo {
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::TCAcknowledgementsRequired::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace TCAcknowledgementsRequired
				...
				namespace RecoveryIdentifier
				{
					struct TypeInfo {
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::RecoveryIdentifier::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
				...
				namespace NetworkRecoveryReason
				{
					struct TypeInfo {
						using Type = chip::app::DataModel::Nullable<
							chip::app::Clusters::GeneralCommissioning::
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::NetworkRecoveryReason::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace NetworkRecoveryReason
				...
				struct TypeInfo {
					struct DecodableType {
						...
						Attributes::BasicCommissioningInfo::TypeInfo::DecodableType
							basicCommissioningInfo;
						Attributes::RegulatoryConfig::TypeInfo::DecodableType regulatoryConfig =
							static_cast<chip::app::Clusters::GeneralCommissioning::
									    RegulatoryLocationTypeEnum>(0);
						Attributes::LocationCapability::TypeInfo::DecodableType
							locationCapability =
								static_cast<chip::app::Clusters::GeneralCommissioning::
										    RegulatoryLocationTypeEnum>(0);
						Attributes::SupportsConcurrentConnection::TypeInfo::DecodableType
							supportsConcurrentConnection = static_cast<bool>(0);
						Attributes::TCAcceptedVersion::TypeInfo::DecodableType
							TCAcceptedVersion = static_cast<uint16_t>(0);
						Attributes::TCMinRequiredVersion::TypeInfo::DecodableType
							TCMinRequiredVersion = static_cast<uint16_t>(0);
						Attributes::TCAcknowledgements::TypeInfo::DecodableType
						...
						Attributes::RecoveryIdentifier::TypeInfo::DecodableType
							recoveryIdentifier;
