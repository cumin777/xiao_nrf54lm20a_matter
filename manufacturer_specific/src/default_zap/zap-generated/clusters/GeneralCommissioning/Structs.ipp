			...
			namespace Structs
			{
				...
				namespace BasicCommissioningInfo
				{
					CHIP_ERROR Type::Encode(TLV::TLVWriter &aWriter, TLV::Tag aTag) const
					{
						...
						encoder.Encode(to_underlying(Fields::kFailSafeExpiryLengthSeconds),
							       failSafeExpiryLengthSeconds);
						encoder.Encode(to_underlying(Fields::kMaxCumulativeFailsafeSeconds),
					...
					CHIP_ERROR DecodableType::Decode(TLV::TLVReader &reader)
					{
						...
						while (true) {
							...
							if (__context_tag ==
							    to_underlying(Fields::kFailSafeExpiryLengthSeconds)) {
								err = DataModel::Decode(reader,
											failSafeExpiryLengthSeconds);
							} else if (__context_tag ==
								   to_underlying(
									   Fields::kMaxCumulativeFailsafeSeconds)) {
								err = DataModel::Decode(reader,
											maxCumulativeFailsafeSeconds);
							}
