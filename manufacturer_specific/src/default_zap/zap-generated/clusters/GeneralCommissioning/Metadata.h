	...
	namespace Clusters
	{
		namespace GeneralCommissioning
		{
			...
			namespace Attributes
			{
				...
				namespace Breadcrumb
				{
					inline constexpr DataModel::AttributeEntry kMetadataEntry(
						Breadcrumb::Id, BitFlags<DataModel::AttributeQualityFlags>(),
						Access::Privilege::kView, Access::Privilege::kAdminister);
				} // namespace Breadcrumb
				namespace BasicCommissioningInfo
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(BasicCommissioningInfo::Id,
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(RegulatoryConfig::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace RegulatoryConfig
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(LocationCapability::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace LocationCapability
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(SupportsConcurrentConnection::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace SupportsConcurrentConnection
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(TCAcceptedVersion::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(TCMinRequiredVersion::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kAdminister, std::nullopt);
				} // namespace TCMinRequiredVersion
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(TCAcknowledgements::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kAdminister, std::nullopt);
				} // namespace TCAcknowledgements
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(TCAcknowledgementsRequired::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kAdminister, std::nullopt);
				} // namespace TCAcknowledgementsRequired
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(TCUpdateDeadline::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kAdminister, std::nullopt);
				} // namespace TCUpdateDeadline
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(RecoveryIdentifier::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(NetworkRecoveryReason::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kManage, std::nullopt);
				} // namespace NetworkRecoveryReason
			...
			namespace Commands
			{
				...
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(SetRegulatoryConfig::Id,
							       BitFlags<DataModel::CommandQualityFlags>(),
							       Access::Privilege::kAdminister);
				} // namespace SetRegulatoryConfig
				...
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(SetTCAcknowledgements::Id,
							       BitFlags<DataModel::CommandQualityFlags>(),
							       Access::Privilege::kAdminister);
				} // namespace SetTCAcknowledgements
