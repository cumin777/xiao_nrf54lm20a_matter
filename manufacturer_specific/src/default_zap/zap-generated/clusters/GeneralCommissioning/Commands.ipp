			...
			namespace Commands
			{
				namespace ArmFailSafe
				{
					...
					CHIP_ERROR Type::Encode(TLV::TLVWriter &aWriter, TLV::Tag aTag) const
					{
						...
						encoder.Encode(to_underlying(Fields::kExpiryLengthSeconds),
							       expiryLengthSeconds);
					...
					CHIP_ERROR DecodableType::Decode(TLV::TLVReader &reader)
					{
						...
						while (true) {
							...
							if (__context_tag ==
							    to_underlying(Fields::kExpiryLengthSeconds)) {
				...
				namespace SetRegulatoryConfig
				{
					...
					{
						DataModel::WrappedStructEncoder encoder{ aWriter, aTag };
						encoder.Encode(to_underlying(Fields::kNewRegulatoryConfig),
							       newRegulatoryConfig);
					...
					CHIP_ERROR DecodableType::Decode(TLV::TLVReader &reader)
					{
						...
						while (true) {
							...
							if (__context_tag ==
							    to_underlying(Fields::kNewRegulatoryConfig)) {
								err = DataModel::Decode(reader, newRegulatoryConfig);
							} else if (__context_tag ==
								   to_underlying(Fields::kCountryCode)) {
						...
						while (true) {
							...
							if (__context_tag == to_underlying(Fields::kTCVersion)) {
								err = DataModel::Decode(reader, TCVersion);
								   ...
								   to_underlying(Fields::kTCUserResponse)) {
