			...
			namespace Commands
			{
				namespace ArmFailSafe
				{
					...
					public:
						...
						{
							return Commands::ArmFailSafe::Id;
						}
						...
						using ResponseType = Clusters::GeneralCommissioning::Commands::
							ArmFailSafeResponse::DecodableType;
				...
				namespace ArmFailSafeResponse
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::ArmFailSafeResponse::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::GeneralCommissioning::Id;
						...
						CommissioningErrorEnum errorCode =
							static_cast<CommissioningErrorEnum>(0);
				...
				namespace SetRegulatoryConfig
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::SetRegulatoryConfig::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::GeneralCommissioning::Id;
						...
						RegulatoryLocationTypeEnum newRegulatoryConfig =
							static_cast<RegulatoryLocationTypeEnum>(0);
						...
						using ResponseType = Clusters::GeneralCommissioning::Commands::
							SetRegulatoryConfigResponse::DecodableType;
				...
				namespace SetRegulatoryConfigResponse
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::SetRegulatoryConfigResponse::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::GeneralCommissioning::Id;
				...
				namespace CommissioningComplete
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::CommissioningComplete::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::GeneralCommissioning::Id;
						...
						using ResponseType = Clusters::GeneralCommissioning::Commands::
							CommissioningCompleteResponse::DecodableType;
				...
				namespace CommissioningCompleteResponse
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::CommissioningCompleteResponse::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::GeneralCommissioning::Id;
				...
				namespace SetTCAcknowledgements
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::SetTCAcknowledgements::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::GeneralCommissioning::Id;
						...
						using ResponseType = Clusters::GeneralCommissioning::Commands::
							SetTCAcknowledgementsResponse::DecodableType;
				...
				namespace SetTCAcknowledgementsResponse
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::SetTCAcknowledgementsResponse::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::GeneralCommissioning::Id;
