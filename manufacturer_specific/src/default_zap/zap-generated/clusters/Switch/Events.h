			...
			namespace Events
			{
				namespace SwitchLatched
				{
					...
					public:
						...
						{
							return Events::SwitchLatched::Id;
						}
				...
				namespace MultiPressOngoing
				{
					...
					public:
						...
						static constexpr EventId GetEventId()
						{
							return Events::MultiPressOngoing::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::Switch::Id;
				...
				namespace MultiPressComplete
				{
					...
					public:
						...
						static constexpr EventId GetEventId()
						{
							return Events::MultiPressComplete::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::Switch::Id;
