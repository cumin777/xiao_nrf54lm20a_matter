			...
			namespace Commands
			{
				namespace QueryImage
				{
					...
					CHIP_ERROR Type::Encode(TLV::TLVWriter &aWriter, TLV::Tag aTag) const
					{
						...
						encoder.Encode(to_underlying(Fields::kSoftwareVersion),
							       softwareVersion);
						encoder.Encode(to_underlying(Fields::kProtocolsSupported),
							       protocolsSupported);
						encoder.Encode(to_underlying(Fields::kHardwareVersion),
							       hardwareVersion);
						encoder.Encode(to_underlying(Fields::kLocation), location);
						encoder.Encode(to_underlying(Fields::kRequestorCanConsent),
							       requestorCanConsent);
						encoder.Encode(to_underlying(Fields::kMetadataForProvider),
							       metadataForProvider);
						...
						while (true) {
							...
							if (__context_tag == to_underlying(Fields::kVendorID)) {
								...
								err = DataModel::Decode(reader, productID);
								   ...
								   to_underlying(Fields::kSoftwareVersion)) {
								err = DataModel::Decode(reader, softwareVersion);
							} else if (__context_tag ==
								   to_underlying(Fields::kProtocolsSupported)) {
								err = DataModel::Decode(reader, protocolsSupported);
							} else if (__context_tag ==
								   to_underlying(Fields::kHardwareVersion)) {
								...
								err = DataModel::Decode(reader, location);
								   ...
								   to_underlying(Fields::kRequestorCanConsent)) {
								err = DataModel::Decode(reader, requestorCanConsent);
							} else if (__context_tag ==
								   to_underlying(Fields::kMetadataForProvider)) {
				...
				namespace QueryImageResponse
				{
								...
								TLV::Tag aTag) const
					{
						...
						encoder.Encode(to_underlying(Fields::kDelayedActionTime),
							       delayedActionTime);
						encoder.Encode(to_underlying(Fields::kImageURI), imageURI);
						encoder.Encode(to_underlying(Fields::kSoftwareVersion),
							       softwareVersion);
						encoder.Encode(to_underlying(Fields::kSoftwareVersionString),
							       softwareVersionString);
						encoder.Encode(to_underlying(Fields::kUpdateToken), updateToken);
						encoder.Encode(to_underlying(Fields::kUserConsentNeeded),
							       userConsentNeeded);
						encoder.Encode(to_underlying(Fields::kMetadataForRequestor),
						...
						while (true) {
							...
							if (__context_tag == to_underlying(Fields::kStatus)) {
								err = DataModel::Decode(reader, status);
								   ...
								   to_underlying(Fields::kDelayedActionTime)) {
								...
								err = DataModel::Decode(reader, softwareVersion);
								   ...
								   to_underlying(Fields::kSoftwareVersionString)) {
								err = DataModel::Decode(reader, softwareVersionString);
							} else if (__context_tag ==
								   to_underlying(Fields::kUpdateToken)) {
								err = DataModel::Decode(reader, updateToken);
							} else if (__context_tag ==
								   to_underlying(Fields::kUserConsentNeeded)) {
								err = DataModel::Decode(reader, userConsentNeeded);
							} else if (__context_tag ==
								   to_underlying(Fields::kMetadataForRequestor)) {
						...
						while (true) {
							...
							if (__context_tag == to_underlying(Fields::kUpdateToken)) {
								err = DataModel::Decode(reader, updateToken);
								   ...
								   to_underlying(Fields::kNewVersion)) {
