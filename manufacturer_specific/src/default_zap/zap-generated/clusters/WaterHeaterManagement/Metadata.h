	...
	namespace Clusters
	{
		namespace WaterHeaterManagement
		{
			...
			namespace Attributes
			{
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(EstimatedHeatRequired::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace EstimatedHeatRequired
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(TankPercentage::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace TankPercentage
			...
			namespace Commands
			{
				...
				namespace Boost
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(Boost::Id, BitFlags<DataModel::CommandQualityFlags>(),
							       Access::Privilege::kManage);
				} // namespace Boost
				namespace CancelBoost
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(CancelBoost::Id,
