			...
			namespace Structs
			{
				...
				namespace WaterHeaterBoostInfoStruct
				{
					CHIP_ERROR Type::Encode(TLV::TLVWriter &aWriter, TLV::Tag aTag) const
					{
						...
						encoder.Encode(to_underlying(Fields::kTemporarySetpoint),
							       temporarySetpoint);
						encoder.Encode(to_underlying(Fields::kTargetPercentage),
							       targetPercentage);
						...
						while (true) {
							...
							if (__context_tag == to_underlying(Fields::kDuration)) {
								...
								err = DataModel::Decode(reader, oneShot);
								   ...
								   to_underlying(Fields::kEmergencyBoost)) {
								err = DataModel::Decode(reader, emergencyBoost);
							} else if (__context_tag ==
								   to_underlying(Fields::kTemporarySetpoint)) {
								err = DataModel::Decode(reader, temporarySetpoint);
							} else if (__context_tag ==
								   to_underlying(Fields::kTargetPercentage)) {
								err = DataModel::Decode(reader, targetPercentage);
							} else if (__context_tag ==
								   to_underlying(Fields::kTargetReheat)) {
