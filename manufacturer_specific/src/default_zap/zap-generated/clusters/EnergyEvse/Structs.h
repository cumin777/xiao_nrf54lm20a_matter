		...
		namespace EnergyEvse
		{
			namespace Structs
			{
				...
				namespace ChargingTargetScheduleStruct
				{
					...
					struct Type {
					public:
						chip::BitMask<TargetDayOfWeekBitmap> dayOfWeekForSequence =
							static_cast<chip::BitMask<TargetDayOfWeekBitmap>>(0);
						DataModel::List<const Structs::ChargingTargetStruct::Type>
							chargingTargets;
					...
					public:
						chip::BitMask<TargetDayOfWeekBitmap> dayOfWeekForSequence =
							static_cast<chip::BitMask<TargetDayOfWeekBitmap>>(0);
						DataModel::DecodableList<Structs::ChargingTargetStruct::DecodableType>
							chargingTargets;
