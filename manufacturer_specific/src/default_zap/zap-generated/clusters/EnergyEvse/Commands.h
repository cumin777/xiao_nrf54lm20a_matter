			...
			namespace Commands
			{
				namespace GetTargetsResponse
				{
					...
					public:
						...
						{
							return Commands::GetTargetsResponse::Id;
						}
						...
						DataModel::List<const Structs::ChargingTargetScheduleStruct::Type>
					...
					public:
						...
						DataModel::DecodableList<
							Structs::ChargingTargetScheduleStruct::DecodableType>
							chargingTargetSchedules;
				...
				namespace EnableCharging
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::EnableCharging::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::EnergyEvse::Id;
				...
				namespace EnableDischarging
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::EnableDischarging::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::EnergyEvse::Id;
				...
				namespace StartDiagnostics
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::StartDiagnostics::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::EnergyEvse::Id;
				...
				namespace GetTargets
				{
					...
					public:
						...
						using ResponseType =
							Clusters::EnergyEvse::Commands::GetTargetsResponse::DecodableType;
				...
				namespace ClearTargets
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::ClearTargets::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::EnergyEvse::Id;
