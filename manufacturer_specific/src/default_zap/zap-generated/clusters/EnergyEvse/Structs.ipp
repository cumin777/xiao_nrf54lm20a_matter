			...
			namespace Structs
			{
				...
				namespace ChargingTargetStruct
				{
					CHIP_ERROR Type::Encode(TLV::TLVWriter &aWriter, TLV::Tag aTag) const
					{
						...
						encoder.Encode(to_underlying(Fields::kTargetTimeMinutesPastMidnight),
				...
				namespace ChargingTargetScheduleStruct
				{
					CHIP_ERROR Type::Encode(TLV::TLVWriter &aWriter, TLV::Tag aTag) const
					{
						...
						encoder.Encode(to_underlying(Fields::kChargingTargets),
							       chargingTargets);
						return encoder.Finalize();
					}
						...
						while (true) {
							...
							if (__context_tag ==
								...
								err = DataModel::Decode(reader, dayOfWeekForSequence);
								   ...
								   to_underlying(Fields::kChargingTargets)) {
