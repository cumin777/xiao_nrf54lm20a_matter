			...
			namespace Commands
			{
				namespace GetTargetsResponse
				{
								...
								TLV::Tag aTag) const
					{
						...
						encoder.Encode(to_underlying(Fields::kChargingTargetSchedules),
					...
					CHIP_ERROR DecodableType::Decode(TLV::TLVReader &reader)
					{
						...
						while (true) {
							...
							if (__context_tag ==
							    to_underlying(Fields::kChargingTargetSchedules)) {
				...
				namespace EnableCharging
				{
					...
					{
						DataModel::WrappedStructEncoder encoder{ aWriter, aTag };
						encoder.Encode(to_underlying(Fields::kChargingEnabledUntil),
							       chargingEnabledUntil);
						encoder.Encode(to_underlying(Fields::kMinimumChargeCurrent),
							       minimumChargeCurrent);
						encoder.Encode(to_underlying(Fields::kMaximumChargeCurrent),
					...
					CHIP_ERROR DecodableType::Decode(TLV::TLVReader &reader)
					{
						...
						while (true) {
							...
							if (__context_tag ==
							    to_underlying(Fields::kChargingEnabledUntil)) {
								err = DataModel::Decode(reader, chargingEnabledUntil);
							} else if (__context_tag ==
								   to_underlying(Fields::kMinimumChargeCurrent)) {
								err = DataModel::Decode(reader, minimumChargeCurrent);
							} else if (__context_tag ==
								   to_underlying(Fields::kMaximumChargeCurrent)) {
				...
				namespace EnableDischarging
				{
					...
					{
						DataModel::WrappedStructEncoder encoder{ aWriter, aTag };
						encoder.Encode(to_underlying(Fields::kDischargingEnabledUntil),
							       dischargingEnabledUntil);
						encoder.Encode(to_underlying(Fields::kMaximumDischargeCurrent),
					...
					CHIP_ERROR DecodableType::Decode(TLV::TLVReader &reader)
					{
						...
						while (true) {
							...
							if (__context_tag ==
							    to_underlying(Fields::kDischargingEnabledUntil)) {
								err = DataModel::Decode(reader,
											dischargingEnabledUntil);
							} else if (__context_tag ==
