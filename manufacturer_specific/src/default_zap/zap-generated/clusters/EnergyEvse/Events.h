			...
			namespace Events
			{
				...
				namespace EVNotDetected
				{
					...
					public:
						...
						static constexpr EventId GetEventId()
						{
							return Events::EVNotDetected::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::EnergyEvse::Id;
				...
				namespace EnergyTransferStarted
				{
					...
					public:
						...
						static constexpr EventId GetEventId()
						{
							return Events::EnergyTransferStarted::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::EnergyEvse::Id;
				...
				namespace EnergyTransferStopped
				{
					...
					public:
						...
						static constexpr EventId GetEventId()
						{
							return Events::EnergyTransferStopped::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::EnergyEvse::Id;
						...
						uint32_t sessionID = static_cast<uint32_t>(0);
						StateEnum state = static_cast<StateEnum>(0);
						EnergyTransferStoppedReasonEnum reason =
							static_cast<EnergyTransferStoppedReasonEnum>(0);
