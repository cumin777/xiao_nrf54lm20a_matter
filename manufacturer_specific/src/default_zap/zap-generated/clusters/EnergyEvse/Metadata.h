	...
	namespace Clusters
	{
		namespace EnergyEvse
		{
			...
			namespace Attributes
			{
				...
				namespace State
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(State::Id, BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace State
				namespace SupplyState
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(SupplyState::Id,
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(ChargingEnabledUntil::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace ChargingEnabledUntil
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(DischargingEnabledUntil::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace DischargingEnabledUntil
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(CircuitCapacity::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace CircuitCapacity
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(MinimumChargeCurrent::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace MinimumChargeCurrent
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(MaximumChargeCurrent::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace MaximumChargeCurrent
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(MaximumDischargeCurrent::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace MaximumDischargeCurrent
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(UserMaximumChargeCurrent::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(RandomizationDelayWindow::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, Access::Privilege::kManage);
				} // namespace RandomizationDelayWindow
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(NextChargeStartTime::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace NextChargeStartTime
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(NextChargeTargetTime::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace NextChargeTargetTime
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(NextChargeRequiredEnergy::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace NextChargeRequiredEnergy
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(NextChargeTargetSoC::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace NextChargeTargetSoC
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(ApproximateEVEfficiency::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, Access::Privilege::kManage);
				} // namespace ApproximateEVEfficiency
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(StateOfCharge::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace StateOfCharge
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(BatteryCapacity::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace BatteryCapacity
				namespace VehicleID
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(SessionDuration::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace SessionDuration
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(SessionEnergyCharged::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace SessionEnergyCharged
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(SessionEnergyDischarged::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace SessionEnergyDischarged
			...
			namespace Commands
			{
				...
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(EnableCharging::Id,
							       BitFlags<DataModel::CommandQualityFlags>(
								       DataModel::CommandQualityFlags::kTimed),
							       Access::Privilege::kOperate);
				} // namespace EnableCharging
				...
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(EnableDischarging::Id,
							       BitFlags<DataModel::CommandQualityFlags>(
								       DataModel::CommandQualityFlags::kTimed),
							       Access::Privilege::kOperate);
				} // namespace EnableDischarging
				...
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(StartDiagnostics::Id,
							       BitFlags<DataModel::CommandQualityFlags>(
								       DataModel::CommandQualityFlags::kTimed),
							       Access::Privilege::kOperate);
				} // namespace StartDiagnostics
				...
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(ClearTargets::Id,
							       BitFlags<DataModel::CommandQualityFlags>(
								       DataModel::CommandQualityFlags::kTimed),
							       Access::Privilege::kOperate);
				} // namespace ClearTargets
