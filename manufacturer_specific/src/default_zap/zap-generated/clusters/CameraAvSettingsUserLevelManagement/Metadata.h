			...
			namespace Attributes
			{
				...
				namespace MPTZPosition
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(MPTZPosition::Id,
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(PanMin::Id, BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace PanMin
				namespace PanMax
				{
			...
			namespace Commands
			{
				...
				namespace MPTZSetPosition
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(MPTZSetPosition::Id,
				...
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(MPTZRelativeMove::Id,
							       BitFlags<DataModel::CommandQualityFlags>(),
							       Access::Privilege::kOperate);
				} // namespace MPTZRelativeMove
				...
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(MPTZMoveToPreset::Id,
							       BitFlags<DataModel::CommandQualityFlags>(),
							       Access::Privilege::kOperate);
				} // namespace MPTZMoveToPreset
				...
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(MPTZSavePreset::Id,
							       BitFlags<DataModel::CommandQualityFlags>(),
							       Access::Privilege::kOperate);
				} // namespace MPTZSavePreset
				...
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(MPTZRemovePreset::Id,
							       BitFlags<DataModel::CommandQualityFlags>(),
							       Access::Privilege::kOperate);
				} // namespace MPTZRemovePreset
				...
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(DPTZSetViewport::Id,
							       BitFlags<DataModel::CommandQualityFlags>(),
							       Access::Privilege::kOperate);
				} // namespace DPTZSetViewport
