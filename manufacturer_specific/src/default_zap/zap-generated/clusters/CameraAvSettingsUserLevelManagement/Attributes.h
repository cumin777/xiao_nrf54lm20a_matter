	...
	namespace Clusters
	{
		namespace CameraAvSettingsUserLevelManagement
		{
			namespace Attributes
			{
				...
				{
					struct TypeInfo {
						using Type = chip::app::Clusters::CameraAvSettingsUserLevelManagement::
							Structs::MPTZStruct::Type;
						using DecodableType =
							chip::app::Clusters::CameraAvSettingsUserLevelManagement::
								Structs::MPTZStruct::DecodableType;
						using DecodableArgType =
							const chip::app::Clusters::CameraAvSettingsUserLevelManagement::
								Structs::MPTZStruct::DecodableType &;

						static constexpr ClusterId GetClusterId()
						{
							return Clusters::CameraAvSettingsUserLevelManagement::Id;
						}
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::MPTZPosition::Id;
						}
				...
				namespace MaxPresets
				{
					struct TypeInfo {
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::MaxPresets::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace MaxPresets
				namespace MPTZPresets
				{
					struct TypeInfo {
						using Type = chip::app::DataModel::List<
							const chip::app::Clusters::CameraAvSettingsUserLevelManagement::
								Structs::MPTZPresetStruct::Type>;
						using DecodableType = chip::app::DataModel::DecodableList<
							chip::app::Clusters::CameraAvSettingsUserLevelManagement::
								Structs::MPTZPresetStruct::DecodableType>;
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::MPTZPresets::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace MPTZPresets
				namespace DPTZStreams
				{
					struct TypeInfo {
						using Type = chip::app::DataModel::List<
							const chip::app::Clusters::CameraAvSettingsUserLevelManagement::
								Structs::DPTZStruct::Type>;
						using DecodableType = chip::app::DataModel::DecodableList<
							chip::app::Clusters::CameraAvSettingsUserLevelManagement::
								Structs::DPTZStruct::DecodableType>;
						using DecodableArgType = const chip::app::DataModel::DecodableList<
							chip::app::Clusters::CameraAvSettingsUserLevelManagement::
								Structs::DPTZStruct::DecodableType> &;
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::DPTZStreams::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace DPTZStreams
				...
				namespace MovementState
				{
					struct TypeInfo {
						...
						using DecodableType = chip::app::Clusters::
							CameraAvSettingsUserLevelManagement::PhysicalMovementEnum;
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::MovementState::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace MovementState
				...
				struct TypeInfo {
					struct DecodableType {
						...
						Attributes::MaxPresets::TypeInfo::DecodableType maxPresets =
							static_cast<uint8_t>(0);
						Attributes::MPTZPresets::TypeInfo::DecodableType MPTZPresets;
						Attributes::DPTZStreams::TypeInfo::DecodableType DPTZStreams;
						Attributes::ZoomMax::TypeInfo::DecodableType zoomMax =
							static_cast<uint8_t>(0);
						Attributes::TiltMin::TypeInfo::DecodableType tiltMin =
							static_cast<int16_t>(0);
						Attributes::TiltMax::TypeInfo::DecodableType tiltMax =
							static_cast<int16_t>(0);
						Attributes::PanMin::TypeInfo::DecodableType panMin =
							static_cast<int16_t>(0);
						Attributes::PanMax::TypeInfo::DecodableType panMax =
							static_cast<int16_t>(0);
						Attributes::MovementState::TypeInfo::DecodableType movementState =
							static_cast<
								chip::app::Clusters::CameraAvSettingsUserLevelManagement::
									PhysicalMovementEnum>(0);
