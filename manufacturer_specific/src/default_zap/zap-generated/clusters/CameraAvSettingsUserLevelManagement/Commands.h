			...
			namespace Commands
			{
				namespace MPTZSetPosition
				{
					...
					public:
						...
						{
							return Commands::MPTZSetPosition::Id;
						}
				...
				namespace MPTZRelativeMove
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::MPTZRelativeMove::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::CameraAvSettingsUserLevelManagement::Id;
				...
				namespace MPTZMoveToPreset
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::MPTZMoveToPreset::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::CameraAvSettingsUserLevelManagement::Id;
				...
				namespace MPTZSavePreset
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::MPTZSavePreset::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::CameraAvSettingsUserLevelManagement::Id;
				...
				namespace MPTZRemovePreset
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::MPTZRemovePreset::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::CameraAvSettingsUserLevelManagement::Id;
				...
				namespace DPTZSetViewport
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::DPTZSetViewport::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::CameraAvSettingsUserLevelManagement::Id;
				...
				namespace DPTZRelativeMove
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::DPTZRelativeMove::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::CameraAvSettingsUserLevelManagement::Id;
