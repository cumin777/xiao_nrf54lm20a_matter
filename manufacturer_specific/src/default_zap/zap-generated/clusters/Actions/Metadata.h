			...
			namespace Commands
			{
				...
				namespace InstantAction
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(InstantAction::Id,
				...
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(InstantActionWithTransition::Id,
							       BitFlags<DataModel::CommandQualityFlags>(),
							       Access::Privilege::kOperate);
				} // namespace InstantActionWithTransition
				...
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(StartActionWithDuration::Id,
							       BitFlags<DataModel::CommandQualityFlags>(),
							       Access::Privilege::kOperate);
				} // namespace StartActionWithDuration
				...
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(PauseActionWithDuration::Id,
							       BitFlags<DataModel::CommandQualityFlags>(),
							       Access::Privilege::kOperate);
				} // namespace PauseActionWithDuration
				...
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(ResumeAction::Id,
							       BitFlags<DataModel::CommandQualityFlags>(),
							       Access::Privilege::kOperate);
				} // namespace ResumeAction
				...
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(EnableAction::Id,
							       BitFlags<DataModel::CommandQualityFlags>(),
							       Access::Privilege::kOperate);
				} // namespace EnableAction
				...
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(EnableActionWithDuration::Id,
							       BitFlags<DataModel::CommandQualityFlags>(),
							       Access::Privilege::kOperate);
				} // namespace EnableActionWithDuration
				...
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(DisableAction::Id,
							       BitFlags<DataModel::CommandQualityFlags>(),
							       Access::Privilege::kOperate);
				} // namespace DisableAction
				...
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(DisableActionWithDuration::Id,
							       BitFlags<DataModel::CommandQualityFlags>(),
							       Access::Privilege::kOperate);
				} // namespace DisableActionWithDuration
