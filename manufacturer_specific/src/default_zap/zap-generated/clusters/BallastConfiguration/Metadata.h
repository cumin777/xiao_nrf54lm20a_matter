			...
			namespace Attributes
			{
				...
				namespace PhysicalMinLevel
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(PhysicalMinLevel::Id,
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(PhysicalMaxLevel::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace PhysicalMaxLevel
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(BallastStatus::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace BallastStatus
				namespace MinLevel
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(IntrinsicBallastFactor::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, Access::Privilege::kManage);
				} // namespace IntrinsicBallastFactor
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(BallastFactorAdjustment::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, Access::Privilege::kManage);
				} // namespace BallastFactorAdjustment
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(LampQuantity::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace LampQuantity
				namespace LampType
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(LampManufacturer::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, Access::Privilege::kManage);
				} // namespace LampManufacturer
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(LampRatedHours::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, Access::Privilege::kManage);
				} // namespace LampRatedHours
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(LampBurnHours::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, Access::Privilege::kManage);
				} // namespace LampBurnHours
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(LampAlarmMode::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, Access::Privilege::kManage);
				} // namespace LampAlarmMode
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(LampBurnHoursTripPoint::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, Access::Privilege::kManage);
				} // namespace LampBurnHoursTripPoint
