	...
	namespace Clusters
	{
		namespace ElectricalEnergyMeasurement
		{
			namespace Attributes
			{
				...
				{
					struct TypeInfo {
						using Type = chip::app::Clusters::ElectricalEnergyMeasurement::Structs::
							MeasurementAccuracyStruct::Type;
						using DecodableType = chip::app::Clusters::ElectricalEnergyMeasurement::
							Structs::MeasurementAccuracyStruct::DecodableType;
						using DecodableArgType =
							const chip::app::Clusters::ElectricalEnergyMeasurement::
								Structs::MeasurementAccuracyStruct::DecodableType &;

						static constexpr ClusterId GetClusterId()
						{
							return Clusters::ElectricalEnergyMeasurement::Id;
						}
				...
				namespace CumulativeEnergyImported
				{
					struct TypeInfo {
						using Type = chip::app::DataModel::Nullable<
							chip::app::Clusters::ElectricalEnergyMeasurement::Structs::
								EnergyMeasurementStruct::Type>;
						using DecodableType = chip::app::DataModel::Nullable<
							chip::app::Clusters::ElectricalEnergyMeasurement::Structs::
								EnergyMeasurementStruct::DecodableType>;
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::CumulativeEnergyImported::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace CumulativeEnergyImported
				namespace CumulativeEnergyExported
				{
					struct TypeInfo {
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::CumulativeEnergyExported::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace CumulativeEnergyExported
				namespace PeriodicEnergyImported
				{
					struct TypeInfo {
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::PeriodicEnergyImported::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace PeriodicEnergyImported
				namespace PeriodicEnergyExported
				{
					struct TypeInfo {
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::PeriodicEnergyExported::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace PeriodicEnergyExported
				namespace CumulativeEnergyReset
				{
					struct TypeInfo {
						...
						using DecodableType = chip::app::DataModel::Nullable<
							chip::app::Clusters::ElectricalEnergyMeasurement::Structs::
								CumulativeEnergyResetStruct::DecodableType>;
						using DecodableArgType = const chip::app::DataModel::Nullable<
							chip::app::Clusters::ElectricalEnergyMeasurement::Structs::
								CumulativeEnergyResetStruct::DecodableType> &;
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::CumulativeEnergyReset::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace CumulativeEnergyReset
				...
				struct TypeInfo {
					struct DecodableType {
						...
						Attributes::CumulativeEnergyImported::TypeInfo::DecodableType
							cumulativeEnergyImported;
						Attributes::CumulativeEnergyExported::TypeInfo::DecodableType
							cumulativeEnergyExported;
						Attributes::PeriodicEnergyImported::TypeInfo::DecodableType
							periodicEnergyImported;
						Attributes::PeriodicEnergyExported::TypeInfo::DecodableType
							periodicEnergyExported;
						Attributes::CumulativeEnergyReset::TypeInfo::DecodableType
