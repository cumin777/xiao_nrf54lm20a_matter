	...
	namespace Clusters
	{
		namespace ElectricalEnergyMeasurement
		{
			...
			namespace Attributes
			{
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(CumulativeEnergyImported::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace CumulativeEnergyImported
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(CumulativeEnergyExported::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace CumulativeEnergyExported
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(PeriodicEnergyImported::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace PeriodicEnergyImported
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(PeriodicEnergyExported::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace PeriodicEnergyExported
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(CumulativeEnergyReset::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace CumulativeEnergyReset
