			...
			namespace Attributes
			{
				...
				namespace Condition
				{
					struct TypeInfo {
						...
						{
							return Clusters::ActivatedCarbonFilterMonitoring::Id;
						}
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::Condition::Id;
						}
				...
				{
					struct TypeInfo {
						using Type = chip::app::Clusters::ActivatedCarbonFilterMonitoring::
							DegradationDirectionEnum;
						using DecodableType = chip::app::Clusters::
							ActivatedCarbonFilterMonitoring::DegradationDirectionEnum;
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::DegradationDirection::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace DegradationDirection
				namespace ChangeIndication
				{
					struct TypeInfo {
						...
						using DecodableType = chip::app::Clusters::
							ActivatedCarbonFilterMonitoring::ChangeIndicationEnum;
						using DecodableArgType = chip::app::Clusters::
							ActivatedCarbonFilterMonitoring::ChangeIndicationEnum;
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::ChangeIndication::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace ChangeIndication
				namespace InPlaceIndicator
				{
					struct TypeInfo {
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::InPlaceIndicator::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace InPlaceIndicator
				namespace LastChangedTime
				{
					struct TypeInfo {
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::LastChangedTime::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace LastChangedTime
				namespace ReplacementProductList
				{
					struct TypeInfo {
						using Type = chip::app::DataModel::List<
							const chip::app::Clusters::ActivatedCarbonFilterMonitoring::
								Structs::ReplacementProductStruct::Type>;
						using DecodableType = chip::app::DataModel::DecodableList<
							chip::app::Clusters::ActivatedCarbonFilterMonitoring::Structs::
								ReplacementProductStruct::DecodableType>;
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::ReplacementProductList::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace ReplacementProductList
				...
				struct TypeInfo {
					struct DecodableType {
						...
						Attributes::Condition::TypeInfo::DecodableType condition =
							static_cast<chip::Percent>(0);
						Attributes::DegradationDirection::TypeInfo::DecodableType
							degradationDirection = static_cast<
								chip::app::Clusters::ActivatedCarbonFilterMonitoring::
									DegradationDirectionEnum>(0);
						Attributes::ChangeIndication::TypeInfo::DecodableType changeIndication =
							static_cast<chip::app::Clusters::ActivatedCarbonFilterMonitoring::
									    ChangeIndicationEnum>(0);
						Attributes::InPlaceIndicator::TypeInfo::DecodableType inPlaceIndicator =
							static_cast<bool>(0);
						Attributes::LastChangedTime::TypeInfo::DecodableType lastChangedTime;
						Attributes::ReplacementProductList::TypeInfo::DecodableType
