...
namespace app
{
	namespace Clusters
	{
		...
		EnsureKnownEnumValue(JointFabricDatastore::DatastoreAccessControlEntryAuthModeEnum val)
		{
		...
		static auto __attribute__((unused))
		EnsureKnownEnumValue(JointFabricDatastore::DatastoreAccessControlEntryPrivilegeEnum val)
		{
		...
		static auto __attribute__((unused))
		EnsureKnownEnumValue(JointFabricDatastore::DatastoreGroupKeyMulticastPolicyEnum val)
		{
		...
		static auto __attribute__((unused))
		EnsureKnownEnumValue(JointFabricDatastore::DatastoreGroupKeySecurityPolicyEnum val)
		{
