	...
	namespace Clusters
	{
		namespace JointFabricDatastore
		{
			...
			namespace Attributes
			{
				...
				namespace AnchorRootCA
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(AnchorRootCA::Id,
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(AnchorNodeID::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kAdminister, std::nullopt);
				} // namespace AnchorNodeID
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(AnchorVendorID::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kAdminister, std::nullopt);
				} // namespace AnchorVendorID
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(FriendlyName::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kAdminister, std::nullopt);
				} // namespace FriendlyName
			...
			namespace Commands
			{
				...
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(UpdateKeySet::Id,
							       BitFlags<DataModel::CommandQualityFlags>(),
							       Access::Privilege::kAdminister);
				} // namespace UpdateKeySet
				...
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(RemoveKeySet::Id,
							       BitFlags<DataModel::CommandQualityFlags>(),
							       Access::Privilege::kAdminister);
				} // namespace RemoveKeySet
				namespace AddGroup
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(AddGroup::Id, BitFlags<DataModel::CommandQualityFlags>(),
							       Access::Privilege::kAdminister);
				} // namespace AddGroup
				namespace UpdateGroup
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(UpdateGroup::Id,
							       BitFlags<DataModel::CommandQualityFlags>(),
							       Access::Privilege::kAdminister);
				} // namespace UpdateGroup
				...
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(AddAdmin::Id, BitFlags<DataModel::CommandQualityFlags>(),
							       Access::Privilege::kAdminister);
				} // namespace AddAdmin
				namespace UpdateAdmin
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(UpdateAdmin::Id,
							       BitFlags<DataModel::CommandQualityFlags>(),
							       Access::Privilege::kAdminister);
				} // namespace UpdateAdmin
				...
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(AddPendingNode::Id,
							       BitFlags<DataModel::CommandQualityFlags>(),
							       Access::Privilege::kAdminister);
				} // namespace AddPendingNode
				...
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(AddACLToNode::Id,
							       BitFlags<DataModel::CommandQualityFlags>(),
							       Access::Privilege::kAdminister);
				} // namespace AddACLToNode
				...
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(RemoveACLFromNode::Id,
							       BitFlags<DataModel::CommandQualityFlags>(),
							       Access::Privilege::kAdminister);
				} // namespace RemoveACLFromNode
