			...
			namespace Attributes
			{
				...
				namespace AnchorNodeID
				{
					struct TypeInfo {
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::AnchorNodeID::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace AnchorNodeID
				namespace AnchorVendorID
				{
					struct TypeInfo {
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::AnchorVendorID::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace AnchorVendorID
				namespace FriendlyName
				{
					struct TypeInfo {
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::FriendlyName::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
				...
				namespace GroupKeySetList
				{
					struct TypeInfo {
						using Type = chip::app::DataModel::List<
							const chip::app::Clusters::JointFabricDatastore::Structs::
								DatastoreGroupKeySetStruct::Type>;
						using DecodableType = chip::app::DataModel::DecodableList<
							chip::app::Clusters::JointFabricDatastore::Structs::
								DatastoreGroupKeySetStruct::DecodableType>;
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::GroupKeySetList::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace GroupKeySetList
				namespace GroupList
				{
					struct TypeInfo {
						using Type = chip::app::DataModel::List<
							const chip::app::Clusters::JointFabricDatastore::Structs::
								DatastoreGroupInformationEntryStruct::Type>;
						using DecodableType = chip::app::DataModel::DecodableList<
							chip::app::Clusters::JointFabricDatastore::Structs::
								DatastoreGroupInformationEntryStruct::DecodableType>;
						using DecodableArgType = const chip::app::DataModel::DecodableList<
							chip::app::Clusters::JointFabricDatastore::Structs::
								DatastoreGroupInformationEntryStruct::DecodableType> &;
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::GroupList::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace GroupList
				namespace NodeList
				{
					struct TypeInfo {
						using Type = chip::app::DataModel::List<
							const chip::app::Clusters::JointFabricDatastore::Structs::
								DatastoreNodeInformationEntryStruct::Type>;
						using DecodableType = chip::app::DataModel::DecodableList<
							chip::app::Clusters::JointFabricDatastore::Structs::
								DatastoreNodeInformationEntryStruct::DecodableType>;
						using DecodableArgType = const chip::app::DataModel::DecodableList<
							chip::app::Clusters::JointFabricDatastore::Structs::
								DatastoreNodeInformationEntryStruct::DecodableType> &;
				...
				namespace AdminList
				{
					struct TypeInfo {
						using Type = chip::app::DataModel::List<
							const chip::app::Clusters::JointFabricDatastore::Structs::
								DatastoreAdministratorInformationEntryStruct::Type>;
						using DecodableType = chip::app::DataModel::DecodableList<
							chip::app::Clusters::JointFabricDatastore::Structs::
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::AdminList::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace AdminList
				...
				{
					struct TypeInfo {
						using Type = chip::app::Clusters::JointFabricDatastore::Structs::
							DatastoreStatusEntryStruct::Type;
						using DecodableType = chip::app::Clusters::JointFabricDatastore::
							Structs::DatastoreStatusEntryStruct::DecodableType;
						using DecodableArgType =
							const chip::app::Clusters::JointFabricDatastore::Structs::
								DatastoreStatusEntryStruct::DecodableType &;
				...
				namespace EndpointGroupIDList
				{
					struct TypeInfo {
						using Type = chip::app::DataModel::List<
							const chip::app::Clusters::JointFabricDatastore::Structs::
								DatastoreEndpointGroupIDEntryStruct::Type>;
						using DecodableType = chip::app::DataModel::DecodableList<
							chip::app::Clusters::JointFabricDatastore::Structs::
								DatastoreEndpointGroupIDEntryStruct::DecodableType>;
						using DecodableArgType = const chip::app::DataModel::DecodableList<
							chip::app::Clusters::JointFabricDatastore::Structs::
								DatastoreEndpointGroupIDEntryStruct::DecodableType> &;
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::EndpointGroupIDList::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace EndpointGroupIDList
				namespace EndpointBindingList
				{
					struct TypeInfo {
						using Type = chip::app::DataModel::List<
							const chip::app::Clusters::JointFabricDatastore::Structs::
								DatastoreEndpointBindingEntryStruct::Type>;
						using DecodableType = chip::app::DataModel::DecodableList<
							chip::app::Clusters::JointFabricDatastore::Structs::
								DatastoreEndpointBindingEntryStruct::DecodableType>;
						using DecodableArgType = const chip::app::DataModel::DecodableList<
							chip::app::Clusters::JointFabricDatastore::Structs::
								DatastoreEndpointBindingEntryStruct::DecodableType> &;
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::EndpointBindingList::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace EndpointBindingList
				namespace NodeKeySetList
				{
					struct TypeInfo {
						using Type = chip::app::DataModel::List<
							const chip::app::Clusters::JointFabricDatastore::Structs::
								DatastoreNodeKeySetEntryStruct::Type>;
						using DecodableType = chip::app::DataModel::DecodableList<
							chip::app::Clusters::JointFabricDatastore::Structs::
								DatastoreNodeKeySetEntryStruct::DecodableType>;
						using DecodableArgType = const chip::app::DataModel::DecodableList<
							chip::app::Clusters::JointFabricDatastore::Structs::
								DatastoreNodeKeySetEntryStruct::DecodableType> &;
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::NodeKeySetList::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace NodeKeySetList
				namespace NodeACLList
				{
					struct TypeInfo {
						using Type = chip::app::DataModel::List<
							const chip::app::Clusters::JointFabricDatastore::Structs::
								DatastoreACLEntryStruct::Type>;
						using DecodableType = chip::app::DataModel::DecodableList<
							chip::app::Clusters::JointFabricDatastore::Structs::
								DatastoreACLEntryStruct::DecodableType>;
						using DecodableArgType = const chip::app::DataModel::DecodableList<
							chip::app::Clusters::JointFabricDatastore::Structs::
								DatastoreACLEntryStruct::DecodableType> &;
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::NodeACLList::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace NodeACLList
				namespace NodeEndpointList
				{
					struct TypeInfo {
						using Type = chip::app::DataModel::List<
							const chip::app::Clusters::JointFabricDatastore::Structs::
								DatastoreEndpointEntryStruct::Type>;
						using DecodableType = chip::app::DataModel::DecodableList<
							chip::app::Clusters::JointFabricDatastore::Structs::
								DatastoreEndpointEntryStruct::DecodableType>;
						using DecodableArgType = const chip::app::DataModel::DecodableList<
							chip::app::Clusters::JointFabricDatastore::Structs::
								DatastoreEndpointEntryStruct::DecodableType> &;
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::NodeEndpointList::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace NodeEndpointList
				...
				struct TypeInfo {
					struct DecodableType {
						...
						Attributes::AnchorNodeID::TypeInfo::DecodableType anchorNodeID =
							static_cast<chip::NodeId>(0);
						Attributes::AnchorVendorID::TypeInfo::DecodableType anchorVendorID =
						...
						Attributes::EndpointGroupIDList::TypeInfo::DecodableType
							endpointGroupIDList;
						Attributes::EndpointBindingList::TypeInfo::DecodableType
							endpointBindingList;
