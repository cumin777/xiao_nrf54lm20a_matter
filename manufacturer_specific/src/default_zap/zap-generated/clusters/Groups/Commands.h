			...
			namespace Commands
			{
				namespace AddGroup
				{
					...
					public:
						...
						using ResponseType =
							Clusters::Groups::Commands::AddGroupResponse::DecodableType;
				...
				namespace AddGroupResponse
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::AddGroupResponse::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::Groups::Id;
				...
				namespace ViewGroup
				{
					...
					public:
						...
						using ResponseType =
							Clusters::Groups::Commands::ViewGroupResponse::DecodableType;
				...
				namespace ViewGroupResponse
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::ViewGroupResponse::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::Groups::Id;
				...
				namespace GetGroupMembership
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::GetGroupMembership::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::Groups::Id;
						...
						using ResponseType = Clusters::Groups::Commands::
							GetGroupMembershipResponse::DecodableType;
				...
				namespace GetGroupMembershipResponse
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::GetGroupMembershipResponse::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::Groups::Id;
				...
				namespace RemoveGroup
				{
					...
					public:
						...
						using ResponseType =
							Clusters::Groups::Commands::RemoveGroupResponse::DecodableType;
				...
				namespace RemoveGroupResponse
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::RemoveGroupResponse::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::Groups::Id;
				...
				namespace RemoveAllGroups
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::RemoveAllGroups::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::Groups::Id;
				...
				namespace AddGroupIfIdentifying
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::AddGroupIfIdentifying::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::Groups::Id;
