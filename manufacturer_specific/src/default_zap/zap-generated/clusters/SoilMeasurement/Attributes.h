	...
	namespace Clusters
	{
		namespace SoilMeasurement
		{
			namespace Attributes
			{
				...
				{
					struct TypeInfo {
						using Type = chip::app::Clusters::Globals::Structs::
						...
						{
							return Clusters::SoilMeasurement::Id;
						}
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::SoilMoistureMeasurementLimits::Id;
						}
				...
				namespace SoilMoistureMeasuredValue
				{
					struct TypeInfo {
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::SoilMoistureMeasuredValue::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace SoilMoistureMeasuredValue
				...
				struct TypeInfo {
					struct DecodableType {
						...
						Attributes::SoilMoistureMeasurementLimits::TypeInfo::DecodableType
							soilMoistureMeasurementLimits;
						Attributes::SoilMoistureMeasuredValue::TypeInfo::DecodableType
