			...
			namespace Commands
			{
				namespace SuppressAlarm
				{
					...
					public:
						...
						{
							return Commands::SuppressAlarm::Id;
						}
						...
						chip::BitMask<AlarmModeBitmap> alarmsToSuppress =
				...
				namespace EnableDisableAlarm
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::EnableDisableAlarm::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::BooleanStateConfiguration::Id;
						...
						chip::BitMask<AlarmModeBitmap> alarmsToEnableDisable =
							static_cast<chip::BitMask<AlarmModeBitmap>>(0);
