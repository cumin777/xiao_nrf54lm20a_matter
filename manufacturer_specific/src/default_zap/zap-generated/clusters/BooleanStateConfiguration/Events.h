			...
			namespace Events
			{
				namespace AlarmsStateChanged
				{
					...
					public:
						...
						{
							return Events::AlarmsStateChanged::Id;
						}
						...
						chip::BitMask<AlarmModeBitmap> alarmsActive =
							static_cast<chip::BitMask<AlarmModeBitmap>>(0);
				...
				namespace SensorFault
				{
					...
					public:
						...
						chip::BitMask<SensorFaultBitmap> sensorFault =
							static_cast<chip::BitMask<SensorFaultBitmap>>(0);
