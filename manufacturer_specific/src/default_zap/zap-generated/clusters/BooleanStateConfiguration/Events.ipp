				...
				namespace AlarmsStateChanged
				{
					CHIP_ERROR Type::Encode(TLV::TLVWriter &aWriter, TLV::Tag aTag) const
					{
						...
						ReturnErrorOnFailure(DataModel::Encode(
							aWriter, TLV::ContextTag(Fields::kAlarmsActive), alarmsActive));
						ReturnErrorOnFailure(DataModel::Encode(
							aWriter, TLV::ContextTag(Fields::kAlarmsSuppressed),
							alarmsSuppressed));
						...
						while (true) {
							...
							if (__context_tag == to_underlying(Fields::kAlarmsActive)) {
								err = DataModel::Decode(reader, alarmsActive);
								   ...
								   to_underlying(Fields::kAlarmsSuppressed)) {
				...
				namespace SensorFault
				{
					CHIP_ERROR Type::Encode(TLV::TLVWriter &aWriter, TLV::Tag aTag) const
					{
						...
						ReturnErrorOnFailure(
							aWriter.StartContainer(aTag, TLV::kTLVType_Structure, outer));
						ReturnErrorOnFailure(DataModel::Encode(
							aWriter, TLV::ContextTag(Fields::kSensorFault), sensorFault));
						return aWriter.EndContainer(outer);
					}
