			...
			namespace Attributes
			{
				...
				namespace MeteredQuantity
				{
					struct TypeInfo {
						using Type = chip::app::DataModel::Nullable<chip::app::DataModel::List<
							const chip::app::Clusters::CommodityMetering::Structs::
								MeteredQuantityStruct::Type>>;
						using DecodableType = chip::app::DataModel::Nullable<
							chip::app::DataModel::DecodableList<
								chip::app::Clusters::CommodityMetering::Structs::
									MeteredQuantityStruct::DecodableType>>;
						...
						{
							return Attributes::MeteredQuantity::Id;
						}
				...
				namespace MeteredQuantityTimestamp
				{
					struct TypeInfo {
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::MeteredQuantityTimestamp::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace MeteredQuantityTimestamp
