				...
				namespace MeasurementAccuracyStruct
				{
					...
					public:
						MeasurementTypeEnum measurementType =
							static_cast<MeasurementTypeEnum>(0);
						...
						DataModel::List<const Structs::MeasurementAccuracyRangeStruct::Type>
							accuracyRanges;
					...
					public:
						...
						DataModel::DecodableList<
							Structs::MeasurementAccuracyRangeStruct::DecodableType>
							accuracyRanges;
			...
			namespace Structs
			{
				...
				namespace MeasurementAccuracyStruct
				{
					...
					public:
						Globals::MeasurementTypeEnum measurementType =
							static_cast<Globals::MeasurementTypeEnum>(0);
						bool measured = static_cast<bool>(0);
						int64_t minMeasuredValue = static_cast<int64_t>(0);
						int64_t maxMeasuredValue = static_cast<int64_t>(0);
						DataModel::List<
							const Globals::Structs::MeasurementAccuracyRangeStruct::Type>
							accuracyRanges;
					...
					public:
						...
						int64_t maxMeasuredValue = static_cast<int64_t>(0);
						DataModel::DecodableList<
							Globals::Structs::MeasurementAccuracyRangeStruct::DecodableType>
							accuracyRanges;
				...
				namespace PowerThresholdStruct
				{
					...
					public:
						...
						DataModel::Nullable<Globals::PowerThresholdSourceEnum>
