			...
			namespace Attributes
			{
				...
				namespace SupportedFormats
				{
					struct TypeInfo {
						using Type = chip::app::DataModel::List<
							const chip::app::Clusters::PushAvStreamTransport::Structs::
								SupportedFormatStruct::Type>;
						using DecodableType = chip::app::DataModel::DecodableList<
							chip::app::Clusters::PushAvStreamTransport::Structs::
								SupportedFormatStruct::DecodableType>;
						...
						{
							return Attributes::SupportedFormats::Id;
						}
				...
				namespace CurrentConnections
				{
					struct TypeInfo {
						using Type = chip::app::DataModel::List<
							const chip::app::Clusters::PushAvStreamTransport::Structs::
								TransportConfigurationStruct::Type>;
						using DecodableType = chip::app::DataModel::DecodableList<
							chip::app::Clusters::PushAvStreamTransport::Structs::
								TransportConfigurationStruct::DecodableType>;
						using DecodableArgType = const chip::app::DataModel::DecodableList<
							chip::app::Clusters::PushAvStreamTransport::Structs::
								TransportConfigurationStruct::DecodableType> &;
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::CurrentConnections::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace CurrentConnections
				...
				struct TypeInfo {
					struct DecodableType {
						...
						Attributes::CurrentConnections::TypeInfo::DecodableType
							currentConnections;
