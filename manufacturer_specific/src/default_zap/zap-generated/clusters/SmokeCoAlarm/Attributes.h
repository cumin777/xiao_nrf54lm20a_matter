			...
			namespace Attributes
			{
				...
				namespace ExpressedState
				{
					struct TypeInfo {
						...
						{
							return Attributes::ExpressedState::Id;
						}
				...
				namespace SmokeState
				{
					struct TypeInfo {
						...
						using DecodableArgType =
							chip::app::Clusters::SmokeCoAlarm::AlarmStateEnum;
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::SmokeState::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace SmokeState
				...
				namespace BatteryAlert
				{
					struct TypeInfo {
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::BatteryAlert::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace BatteryAlert
				namespace DeviceMuted
				{
					struct TypeInfo {
						...
						using DecodableArgType =
							chip::app::Clusters::SmokeCoAlarm::MuteStateEnum;
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::DeviceMuted::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace DeviceMuted
				namespace TestInProgress
				{
					struct TypeInfo {
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::TestInProgress::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace TestInProgress
				namespace HardwareFaultAlert
				{
					struct TypeInfo {
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::HardwareFaultAlert::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace HardwareFaultAlert
				namespace EndOfServiceAlert
				{
					struct TypeInfo {
						...
						using DecodableType =
							chip::app::Clusters::SmokeCoAlarm::EndOfServiceEnum;
						using DecodableArgType =
							chip::app::Clusters::SmokeCoAlarm::EndOfServiceEnum;
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::EndOfServiceAlert::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace EndOfServiceAlert
				namespace InterconnectSmokeAlarm
				{
					struct TypeInfo {
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::InterconnectSmokeAlarm::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace InterconnectSmokeAlarm
				namespace InterconnectCOAlarm
				{
					struct TypeInfo {
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::InterconnectCOAlarm::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace InterconnectCOAlarm
				namespace ContaminationState
				{
					struct TypeInfo {
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::ContaminationState::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace ContaminationState
				namespace SmokeSensitivityLevel
				{
					struct TypeInfo {
						...
						using DecodableType =
							chip::app::Clusters::SmokeCoAlarm::SensitivityEnum;
						using DecodableArgType =
							chip::app::Clusters::SmokeCoAlarm::SensitivityEnum;
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::SmokeSensitivityLevel::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace SmokeSensitivityLevel
				namespace ExpiryDate
				{
					struct TypeInfo {
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::ExpiryDate::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace ExpiryDate
				...
				struct TypeInfo {
					struct DecodableType {
						...
						Attributes::SmokeState::TypeInfo::DecodableType smokeState =
							static_cast<chip::app::Clusters::SmokeCoAlarm::AlarmStateEnum>(
								0);
						Attributes::COState::TypeInfo::DecodableType COState =
							static_cast<chip::app::Clusters::SmokeCoAlarm::AlarmStateEnum>(
								0);
						...
						Attributes::DeviceMuted::TypeInfo::DecodableType deviceMuted =
							static_cast<chip::app::Clusters::SmokeCoAlarm::MuteStateEnum>(
								0);
						Attributes::TestInProgress::TypeInfo::DecodableType testInProgress =
							static_cast<bool>(0);
						Attributes::HardwareFaultAlert::TypeInfo::DecodableType
							hardwareFaultAlert = static_cast<bool>(0);
						Attributes::EndOfServiceAlert::TypeInfo::DecodableType endOfServiceAlert =
							static_cast<chip::app::Clusters::SmokeCoAlarm::EndOfServiceEnum>(
								0);
						Attributes::InterconnectSmokeAlarm::TypeInfo::DecodableType
							interconnectSmokeAlarm = static_cast<
								chip::app::Clusters::SmokeCoAlarm::AlarmStateEnum>(0);
						Attributes::InterconnectCOAlarm::TypeInfo::DecodableType
							interconnectCOAlarm = static_cast<
								chip::app::Clusters::SmokeCoAlarm::AlarmStateEnum>(0);
						Attributes::ContaminationState::TypeInfo::DecodableType
							contaminationState =
								static_cast<chip::app::Clusters::SmokeCoAlarm::
										    ContaminationStateEnum>(0);
						Attributes::SmokeSensitivityLevel::TypeInfo::DecodableType
							smokeSensitivityLevel = static_cast<
