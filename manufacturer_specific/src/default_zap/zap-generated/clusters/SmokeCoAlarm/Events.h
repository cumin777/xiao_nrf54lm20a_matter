			...
			namespace Events
			{
				...
				namespace HardwareFault
				{
					...
					public:
						...
						{
							return Events::HardwareFault::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::SmokeCoAlarm::Id;
				...
				namespace SelfTestComplete
				{
					...
					public:
						...
						static constexpr EventId GetEventId()
						{
							return Events::SelfTestComplete::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::SmokeCoAlarm::Id;
				...
				namespace InterconnectSmokeAlarm
				{
					...
					public:
						...
						static constexpr EventId GetEventId()
						{
							return Events::InterconnectSmokeAlarm::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::SmokeCoAlarm::Id;
				...
				namespace InterconnectCOAlarm
				{
					...
					public:
						...
						static constexpr EventId GetEventId()
						{
							return Events::InterconnectCOAlarm::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::SmokeCoAlarm::Id;
