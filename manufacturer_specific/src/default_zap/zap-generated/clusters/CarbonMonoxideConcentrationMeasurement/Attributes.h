			...
			namespace Attributes
			{
				...
				namespace MeasuredValue
				{
					struct TypeInfo {
						...
						{
							return Clusters::CarbonMonoxideConcentrationMeasurement::Id;
						}
				...
				namespace MeasurementMedium
				{
					struct TypeInfo {
						using Type = chip::app::Clusters::
							CarbonMonoxideConcentrationMeasurement::MeasurementMediumEnum;
						using DecodableType = chip::app::Clusters::
							CarbonMonoxideConcentrationMeasurement::MeasurementMediumEnum;
						using DecodableArgType = chip::app::Clusters::
							CarbonMonoxideConcentrationMeasurement::MeasurementMediumEnum;
				...
				namespace LevelValue
				{
					struct TypeInfo {
						using Type = chip::app::Clusters::
							CarbonMonoxideConcentrationMeasurement::LevelValueEnum;
						using DecodableType = chip::app::Clusters::
							CarbonMonoxideConcentrationMeasurement::LevelValueEnum;
						using DecodableArgType = chip::app::Clusters::
							CarbonMonoxideConcentrationMeasurement::LevelValueEnum;
				...
				struct TypeInfo {
					struct DecodableType {
						...
						Attributes::LevelValue::TypeInfo::DecodableType levelValue = static_cast<
							chip::app::Clusters::CarbonMonoxideConcentrationMeasurement::
								LevelValueEnum>(0);
