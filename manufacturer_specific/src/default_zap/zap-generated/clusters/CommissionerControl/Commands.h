			...
			namespace Commands
			{
				namespace RequestCommissioningApproval
				{
					...
					public:
						...
						{
							return Commands::RequestCommissioningApproval::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::CommissionerControl::Id;
						}
				...
				namespace CommissionNode
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::CommissionNode::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::CommissionerControl::Id;
						...
						using ResponseType = Clusters::CommissionerControl::Commands::
							ReverseOpenCommissioningWindow::DecodableType;
				...
				namespace ReverseOpenCommissioningWindow
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::ReverseOpenCommissioningWindow::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::CommissionerControl::Id;
