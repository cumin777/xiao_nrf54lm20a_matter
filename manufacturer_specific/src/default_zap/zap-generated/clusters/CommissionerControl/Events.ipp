				...
				namespace CommissioningRequestResult
				{
					CHIP_ERROR Type::Encode(TLV::TLVWriter &aWriter, TLV::Tag aTag) const
					{
						...
						ReturnErrorOnFailure(DataModel::Encode(
							aWriter, TLV::ContextTag(Fields::kRequestID), requestID));
						ReturnErrorOnFailure(DataModel::Encode(
							aWriter, TLV::ContextTag(Fields::kClientNodeID), clientNodeID));
						ReturnErrorOnFailure(DataModel::Encode(
							aWriter, TLV::ContextTag(Fields::kStatusCode), statusCode));
						ReturnErrorOnFailure(DataModel::Encode(
						...
						while (true) {
							...
							if (__context_tag == to_underlying(Fields::kRequestID)) {
								err = DataModel::Decode(reader, requestID);
								   ...
								   to_underlying(Fields::kClientNodeID)) {
