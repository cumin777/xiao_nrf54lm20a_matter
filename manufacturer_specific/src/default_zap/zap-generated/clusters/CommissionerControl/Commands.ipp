			...
			namespace Commands
			{
				...
				namespace CommissionNode
				{
					...
					CHIP_ERROR Type::Encode(TLV::TLVWriter &aWriter, TLV::Tag aTag) const
					{
						DataModel::WrappedStructEncoder encoder{ aWriter, aTag };
						encoder.Encode(to_underlying(Fields::kRequestID), requestID);
						encoder.Encode(to_underlying(Fields::kResponseTimeoutSeconds),
						...
						while (true) {
							...
							if (__context_tag == to_underlying(Fields::kRequestID)) {
								err = DataModel::Decode(reader, requestID);
								   ...
								   to_underlying(Fields::kResponseTimeoutSeconds)) {
				...
				namespace ReverseOpenCommissioningWindow
				{
					...
					{
						DataModel::WrappedStructEncoder encoder{ aWriter, aTag };
						encoder.Encode(to_underlying(Fields::kCommissioningTimeout),
							       commissioningTimeout);
						encoder.Encode(to_underlying(Fields::kPAKEPasscodeVerifier),
					...
					CHIP_ERROR DecodableType::Decode(TLV::TLVReader &reader)
					{
						...
						while (true) {
							...
							if (__context_tag ==
							    to_underlying(Fields::kCommissioningTimeout)) {
								err = DataModel::Decode(reader, commissioningTimeout);
							} else if (__context_tag ==
								   to_underlying(Fields::kPAKEPasscodeVerifier)) {
								err = DataModel::Decode(reader, PAKEPasscodeVerifier);
							} else if (__context_tag ==
								   to_underlying(Fields::kDiscriminator)) {
								err = DataModel::Decode(reader, discriminator);
							} else if (__context_tag ==
								   to_underlying(Fields::kIterations)) {
