	...
	namespace Clusters
	{
		namespace CommissionerControl
		{
			namespace Attributes
			{
				...
				{
					struct TypeInfo {
						using Type = chip::BitMask<chip::app::Clusters::CommissionerControl::
						...
						{
							return Attributes::SupportedDeviceCategories::Id;
						}
				...
				struct TypeInfo {
					struct DecodableType {
						...
						Attributes::SupportedDeviceCategories::TypeInfo::DecodableType
							supportedDeviceCategories = static_cast<
								chip::BitMask<chip::app::Clusters::CommissionerControl::
										      SupportedDeviceCategoryBitmap>>(
								0);
