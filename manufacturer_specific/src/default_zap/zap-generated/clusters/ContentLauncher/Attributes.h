			...
			namespace Attributes
			{
				...
				namespace AcceptHeader
				{
					struct TypeInfo {
						...
						{
							return Clusters::ContentLauncher::Id;
						}
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::AcceptHeader::Id;
						}
				...
				namespace SupportedStreamingProtocols
				{
					struct TypeInfo {
						using Type = chip::BitMask<
							chip::app::Clusters::ContentLauncher::SupportedProtocolsBitmap>;
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::SupportedStreamingProtocols::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace SupportedStreamingProtocols
				...
				struct TypeInfo {
					struct DecodableType {
						...
						Attributes::SupportedStreamingProtocols::TypeInfo::DecodableType
							supportedStreamingProtocols = static_cast<
								chip::BitMask<chip::app::Clusters::ContentLauncher::
										      SupportedProtocolsBitmap>>(0);
