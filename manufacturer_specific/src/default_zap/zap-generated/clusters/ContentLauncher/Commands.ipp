			...
			namespace Commands
			{
				namespace LaunchContent
				{
					...
					CHIP_ERROR Type::Encode(TLV::TLVWriter &aWriter, TLV::Tag aTag) const
					{
						...
						encoder.Encode(to_underlying(Fields::kPlaybackPreferences),
							       playbackPreferences);
						encoder.Encode(to_underlying(Fields::kUseCurrentContext),
							       useCurrentContext);
						...
						while (true) {
							...
							if (__context_tag == to_underlying(Fields::kSearch)) {
								...
								err = DataModel::Decode(reader, data);
								   ...
								   to_underlying(Fields::kPlaybackPreferences)) {
								err = DataModel::Decode(reader, playbackPreferences);
							} else if (__context_tag ==
								   to_underlying(Fields::kUseCurrentContext)) {
				...
				namespace LaunchURL
				{
					...
					CHIP_ERROR Type::Encode(TLV::TLVWriter &aWriter, TLV::Tag aTag) const
					{
						...
						encoder.Encode(to_underlying(Fields::kBrandingInformation),
							       brandingInformation);
						return encoder.Finalize();
					}
						...
						while (true) {
							...
							if (__context_tag == to_underlying(Fields::kContentURL)) {
								err = DataModel::Decode(reader, contentURL);
								   ...
								   to_underlying(Fields::kDisplayString)) {
								err = DataModel::Decode(reader, displayString);
							} else if (__context_tag ==
								   to_underlying(Fields::kBrandingInformation)) {
