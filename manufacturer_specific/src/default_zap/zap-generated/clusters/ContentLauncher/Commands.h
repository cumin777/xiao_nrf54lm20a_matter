			...
			namespace Commands
			{
				namespace LaunchContent
				{
					...
					public:
						...
						{
							return Commands::LaunchContent::Id;
						}
						...
						using ResponseType = Clusters::ContentLauncher::Commands::
							LauncherResponse::DecodableType;
					...
					public:
						...
						bool autoPlay = static_cast<bool>(0);
						Optional<chip::CharSpan> data;
						Optional<Structs::PlaybackPreferencesStruct::DecodableType>
							playbackPreferences;
						Optional<bool> useCurrentContext;
				...
				namespace LaunchURL
				{
					...
					public:
						...
						chip::CharSpan contentURL;
						Optional<chip::CharSpan> displayString;
						Optional<Structs::BrandingInformationStruct::DecodableType>
							brandingInformation;
				...
				namespace LauncherResponse
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::LauncherResponse::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::ContentLauncher::Id;
