			...
			namespace Attributes
			{
				...
				namespace PhaseList
				{
					struct TypeInfo {
						...
						{
							return Clusters::OperationalState::Id;
						}
				...
				namespace OperationalStateList
				{
					struct TypeInfo {
						using Type = chip::app::DataModel::List<
							const chip::app::Clusters::OperationalState::Structs::
								OperationalStateStruct::Type>;
						using DecodableType = chip::app::DataModel::DecodableList<
							chip::app::Clusters::OperationalState::Structs::
				...
				namespace OperationalState
				{
					struct TypeInfo {
						using Type =
							chip::app::Clusters::OperationalState::OperationalStateEnum;
						using DecodableType =
							chip::app::Clusters::OperationalState::OperationalStateEnum;
						using DecodableArgType =
							chip::app::Clusters::OperationalState::OperationalStateEnum;
				...
				{
					struct TypeInfo {
						using Type = chip::app::Clusters::OperationalState::Structs::
							ErrorStateStruct::Type;
						using DecodableType = chip::app::Clusters::OperationalState::Structs::
							ErrorStateStruct::DecodableType;
						using DecodableArgType = const chip::app::Clusters::OperationalState::
				...
				struct TypeInfo {
					struct DecodableType {
						...
						Attributes::OperationalState::TypeInfo::DecodableType operationalState =
							static_cast<chip::app::Clusters::OperationalState::
