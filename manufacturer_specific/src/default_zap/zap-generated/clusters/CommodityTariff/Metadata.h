	...
	namespace Clusters
	{
		namespace CommodityTariff
		{
			...
			namespace Attributes
			{
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(CurrentDayEntry::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace CurrentDayEntry
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(CurrentDayEntryDate::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace CurrentDayEntryDate
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(NextDayEntry::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace NextDayEntry
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(NextDayEntryDate::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace NextDayEntryDate
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(DefaultRandomizationOffset::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace DefaultRandomizationOffset
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(DefaultRandomizationType::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace DefaultRandomizationType
			...
			namespace Commands
			{
				...
				namespace GetTariffComponent
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(GetTariffComponent::Id,
