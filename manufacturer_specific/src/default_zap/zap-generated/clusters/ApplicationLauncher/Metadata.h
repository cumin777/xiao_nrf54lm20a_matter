	...
	namespace Clusters
	{
		namespace ApplicationLauncher
		{
			...
			namespace Commands
			{
				...
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(StopApp::Id, BitFlags<DataModel::CommandQualityFlags>(),
							       Access::Privilege::kOperate);
				} // namespace StopApp
				namespace HideApp
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(HideApp::Id, BitFlags<DataModel::CommandQualityFlags>(),
							       Access::Privilege::kOperate);
				} // namespace HideApp
