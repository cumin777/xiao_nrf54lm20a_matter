			...
			namespace Commands
			{
				namespace LaunchApp
				{
					...
					public:
						...
						{
							return Commands::LaunchApp::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::ApplicationLauncher::Id;
						}
						...
						using ResponseType = Clusters::ApplicationLauncher::Commands::
