			...
			namespace Attributes
			{
				...
				namespace Membership
				{
					struct TypeInfo {
						using Type = chip::app::DataModel::List<
							const chip::app::Clusters::Groupcast::Structs::
								MembershipStruct::Type>;
						using DecodableType = chip::app::DataModel::DecodableList<
							chip::app::Clusters::Groupcast::Structs::MembershipStruct::
								DecodableType>;
						...
						{
							return Attributes::Membership::Id;
						}
				...
				namespace MaxMembershipCount
				{
					struct TypeInfo {
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::MaxMembershipCount::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace MaxMembershipCount
