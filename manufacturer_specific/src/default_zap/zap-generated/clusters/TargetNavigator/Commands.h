			...
			namespace Commands
			{
				namespace NavigateTarget
				{
					...
					public:
						...
						{
							return Commands::NavigateTarget::Id;
						}
						...
						using ResponseType = Clusters::TargetNavigator::Commands::
							NavigateTargetResponse::DecodableType;
				...
				namespace NavigateTargetResponse
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::NavigateTargetResponse::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::TargetNavigator::Id;
