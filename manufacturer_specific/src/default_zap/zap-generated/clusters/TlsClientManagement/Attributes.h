			...
			namespace Attributes
			{
				...
				namespace MaxProvisioned
				{
					struct TypeInfo {
						...
						{
							return Clusters::TlsClientManagement::Id;
						}
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::MaxProvisioned::Id;
						}
				...
				namespace ProvisionedEndpoints
				{
					struct TypeInfo {
						using Type = chip::app::DataModel::List<
							const chip::app::Clusters::TlsClientManagement::Structs::
								TLSEndpointStruct::Type>;
						using DecodableType = chip::app::DataModel::DecodableList<
							chip::app::Clusters::TlsClientManagement::Structs::
								TLSEndpointStruct::DecodableType>;
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::ProvisionedEndpoints::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace ProvisionedEndpoints
				...
				struct TypeInfo {
					struct DecodableType {
						...
						Attributes::MaxProvisioned::TypeInfo::DecodableType maxProvisioned =
							static_cast<uint8_t>(0);
						Attributes::ProvisionedEndpoints::TypeInfo::DecodableType
