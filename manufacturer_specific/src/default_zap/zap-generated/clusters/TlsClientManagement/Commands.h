			...
			namespace Commands
			{
				namespace ProvisionEndpoint
				{
					...
					public:
						...
						{
							return Commands::ProvisionEndpoint::Id;
						}
						...
						using ResponseType = Clusters::TlsClientManagement::Commands::
							ProvisionEndpointResponse::DecodableType;
				...
				namespace ProvisionEndpointResponse
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::ProvisionEndpointResponse::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::TlsClientManagement::Id;
				...
				namespace FindEndpoint
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::FindEndpoint::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::TlsClientManagement::Id;
						...
						using ResponseType = Clusters::TlsClientManagement::Commands::
							FindEndpointResponse::DecodableType;
				...
				namespace FindEndpointResponse
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::FindEndpointResponse::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::TlsClientManagement::Id;
				...
				namespace RemoveEndpoint
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::RemoveEndpoint::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::TlsClientManagement::Id;
