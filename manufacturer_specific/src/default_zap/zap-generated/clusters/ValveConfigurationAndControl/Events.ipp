				...
				namespace ValveStateChanged
				{
					CHIP_ERROR Type::Encode(TLV::TLVWriter &aWriter, TLV::Tag aTag) const
					{
						...
						ReturnErrorOnFailure(DataModel::Encode(
							aWriter, TLV::ContextTag(Fields::kValveState), valveState));
						ReturnErrorOnFailure(DataModel::Encode(
							aWriter, TLV::ContextTag(Fields::kValveLevel), valveLevel));
						...
						while (true) {
							...
							if (__context_tag == to_underlying(Fields::kValveState)) {
								err = DataModel::Decode(reader, valveState);
								   ...
								   to_underlying(Fields::kValveLevel)) {
				...
				namespace ValveFault
				{
					CHIP_ERROR Type::Encode(TLV::TLVWriter &aWriter, TLV::Tag aTag) const
					{
						...
						ReturnErrorOnFailure(
							aWriter.StartContainer(aTag, TLV::kTLVType_Structure, outer));
						ReturnErrorOnFailure(DataModel::Encode(
							aWriter, TLV::ContextTag(Fields::kValveFault), valveFault));
						return aWriter.EndContainer(outer);
					}
