			...
			namespace Structs
			{
				...
				namespace ProgramStruct
				{
					...
					public:
						...
						Optional<DataModel::Nullable<Structs::SeriesInfoStruct::Type>>
							seriesInfo;
						Optional<DataModel::List<const Structs::ProgramCategoryStruct::Type>>
							categoryList;
						Optional<DataModel::List<const Structs::ProgramCastStruct::Type>>
							castList;
						Optional<DataModel::List<const Structs::ProgramCastStruct::Type>>
							externalIDList;
					...
					public:
						...
						Optional<chip::CharSpan> parentalGuidanceText;
						Optional<chip::BitMask<RecordingFlagBitmap>> recordingFlag;
						Optional<DataModel::Nullable<Structs::SeriesInfoStruct::DecodableType>>
							seriesInfo;
						Optional<DataModel::DecodableList<
							Structs::ProgramCategoryStruct::DecodableType>>
							categoryList;
						Optional<DataModel::DecodableList<
							Structs::ProgramCastStruct::DecodableType>>
							castList;
						Optional<DataModel::DecodableList<
							Structs::ProgramCastStruct::DecodableType>>
							externalIDList;
				...
				namespace ChannelPagingStruct
				{
					...
					struct Type {
					public:
						Optional<DataModel::Nullable<Structs::PageTokenStruct::Type>>
							previousToken;
