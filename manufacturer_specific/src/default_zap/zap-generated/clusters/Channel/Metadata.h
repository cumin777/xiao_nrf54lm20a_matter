			...
			namespace Attributes
			{
				...
				namespace Lineup
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(Lineup::Id, BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace Lineup
				namespace CurrentChannel
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(CurrentChannel::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace CurrentChannel
			...
			namespace Commands
			{
				...
				namespace ChangeChannel
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(ChangeChannel::Id,
				...
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(ChangeChannelByNumber::Id,
							       BitFlags<DataModel::CommandQualityFlags>(),
							       Access::Privilege::kOperate);
				} // namespace ChangeChannelByNumber
				...
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(GetProgramGuide::Id,
							       BitFlags<DataModel::CommandQualityFlags>(),
							       Access::Privilege::kOperate);
				} // namespace GetProgramGuide
				...
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(RecordProgram::Id,
							       BitFlags<DataModel::CommandQualityFlags>(),
							       Access::Privilege::kOperate);
				} // namespace RecordProgram
				...
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(CancelRecordProgram::Id,
							       BitFlags<DataModel::CommandQualityFlags>(),
							       Access::Privilege::kOperate);
				} // namespace CancelRecordProgram
