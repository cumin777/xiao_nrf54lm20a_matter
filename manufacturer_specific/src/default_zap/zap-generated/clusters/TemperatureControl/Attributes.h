			...
			namespace Attributes
			{
				...
				namespace TemperatureSetpoint
				{
					struct TypeInfo {
						...
						{
							return Clusters::TemperatureControl::Id;
						}
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::TemperatureSetpoint::Id;
						}
				...
				namespace MinTemperature
				{
					struct TypeInfo {
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::MinTemperature::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace MinTemperature
				namespace MaxTemperature
				{
					struct TypeInfo {
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::MaxTemperature::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace MaxTemperature
				...
				namespace SelectedTemperatureLevel
				{
					struct TypeInfo {
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::SelectedTemperatureLevel::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace SelectedTemperatureLevel
				namespace SupportedTemperatureLevels
				{
					struct TypeInfo {
						...
						using DecodableArgType =
							const chip::app::DataModel::DecodableList<chip::CharSpan> &;
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::SupportedTemperatureLevels::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace SupportedTemperatureLevels
				...
				struct TypeInfo {
					struct DecodableType {
						...
						Attributes::TemperatureSetpoint::TypeInfo::DecodableType
							temperatureSetpoint = static_cast<int16_t>(0);
						Attributes::MinTemperature::TypeInfo::DecodableType minTemperature =
							static_cast<int16_t>(0);
						Attributes::MaxTemperature::TypeInfo::DecodableType maxTemperature =
							static_cast<int16_t>(0);
						Attributes::Step::TypeInfo::DecodableType step =
							static_cast<int16_t>(0);
						Attributes::SelectedTemperatureLevel::TypeInfo::DecodableType
							selectedTemperatureLevel = static_cast<uint8_t>(0);
						Attributes::SupportedTemperatureLevels::TypeInfo::DecodableType
