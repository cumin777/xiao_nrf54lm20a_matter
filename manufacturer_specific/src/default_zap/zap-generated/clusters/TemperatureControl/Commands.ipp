			...
			namespace Commands
			{
				namespace SetTemperature
				{
					...
					CHIP_ERROR Type::Encode(TLV::TLVWriter &aWriter, TLV::Tag aTag) const
					{
						...
						encoder.Encode(to_underlying(Fields::kTargetTemperature),
							       targetTemperature);
						encoder.Encode(to_underlying(Fields::kTargetTemperatureLevel),
					...
					CHIP_ERROR DecodableType::Decode(TLV::TLVReader &reader)
					{
						...
						while (true) {
							...
							if (__context_tag ==
							    to_underlying(Fields::kTargetTemperature)) {
								err = DataModel::Decode(reader, targetTemperature);
							} else if (__context_tag ==
								   to_underlying(Fields::kTargetTemperatureLevel)) {
