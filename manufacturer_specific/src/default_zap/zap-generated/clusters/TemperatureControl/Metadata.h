			...
			namespace Attributes
			{
				...
				namespace TemperatureSetpoint
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(TemperatureSetpoint::Id,
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(MinTemperature::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace MinTemperature
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(MaxTemperature::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace MaxTemperature
				namespace Step
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(Step::Id, BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace Step
				namespace SelectedTemperatureLevel
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(SelectedTemperatureLevel::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace SelectedTemperatureLevel
			...
			namespace Commands
			{
				...
				namespace SetTemperature
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(SetTemperature::Id,
