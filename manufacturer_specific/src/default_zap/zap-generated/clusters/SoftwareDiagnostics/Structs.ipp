			...
			namespace Structs
			{
				...
				namespace ThreadMetricsStruct
				{
					CHIP_ERROR Type::Encode(TLV::TLVWriter &aWriter, TLV::Tag aTag) const
					{
						...
						encoder.Encode(to_underlying(Fields::kStackFreeCurrent),
							       stackFreeCurrent);
						encoder.Encode(to_underlying(Fields::kStackFreeMinimum),
							       stackFreeMinimum);
						...
						while (true) {
							...
							if (__context_tag == to_underlying(Fields::kId)) {
								...
								err = DataModel::Decode(reader, name);
								   ...
								   to_underlying(Fields::kStackFreeCurrent)) {
								err = DataModel::Decode(reader, stackFreeCurrent);
							} else if (__context_tag ==
								   to_underlying(Fields::kStackFreeMinimum)) {
