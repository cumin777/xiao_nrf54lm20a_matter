			...
			namespace Events
			{
				namespace SoftwareFault
				{
					CHIP_ERROR Type::Encode(TLV::TLVWriter &aWriter, TLV::Tag aTag) const
					{
						...
						ReturnErrorOnFailure(
							DataModel::Encode(aWriter, TLV::ContextTag(Fields::kId), id));
						ReturnErrorOnFailure(DataModel::Encode(
							aWriter, TLV::ContextTag(Fields::kName), name));
						ReturnErrorOnFailure(DataModel::Encode(
							aWriter, TLV::ContextTag(Fields::kFaultRecording),
							faultRecording));
						...
						while (true) {
							...
							if (__context_tag == to_underlying(Fields::kId)) {
								...
								err = DataModel::Decode(reader, name);
								   ...
								   to_underlying(Fields::kFaultRecording)) {
