			...
			namespace Events
			{
				namespace AccessControlEntryChanged
				{
					...
					public:
						...
						{
							return Events::AccessControlEntryChanged::Id;
						}
					...
					public:
						...
						DataModel::Nullable<uint16_t> adminPasscodeID;
						ChangeTypeEnum changeType = static_cast<ChangeTypeEnum>(0);
						DataModel::Nullable<Structs::AccessControlEntryStruct::DecodableType>
							latestValue;
						chip::FabricIndex fabricIndex = static_cast<chip::FabricIndex>(0);
				...
				namespace AccessControlExtensionChanged
				{
					...
					public:
						...
						static constexpr EventId GetEventId()
						{
							return Events::AccessControlExtensionChanged::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::AccessControl::Id;
						...
						DataModel::Nullable<uint16_t> adminPasscodeID;
						ChangeTypeEnum changeType = static_cast<ChangeTypeEnum>(0);
						DataModel::Nullable<Structs::AccessControlExtensionStruct::Type>
							latestValue;
						chip::FabricIndex fabricIndex = static_cast<chip::FabricIndex>(0);
					...
					public:
						...
						DataModel::Nullable<uint16_t> adminPasscodeID;
						ChangeTypeEnum changeType = static_cast<ChangeTypeEnum>(0);
						DataModel::Nullable<Structs::AccessControlExtensionStruct::DecodableType>
							latestValue;
						chip::FabricIndex fabricIndex = static_cast<chip::FabricIndex>(0);
				...
				namespace FabricRestrictionReviewUpdate
				{
					...
					public:
						...
						static constexpr EventId GetEventId()
						{
							return Events::FabricRestrictionReviewUpdate::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::AccessControl::Id;
