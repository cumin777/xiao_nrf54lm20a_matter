			...
			namespace Commands
			{
				namespace ReviewFabricRestrictions
				{
					...
					public:
						...
						{
							return Commands::ReviewFabricRestrictions::Id;
						}
						...
						DataModel::List<
							const Structs::CommissioningAccessRestrictionEntryStruct::Type>
							arl;

						CHIP_ERROR Encode(TLV::TLVWriter &aWriter, TLV::Tag aTag) const;

						using ResponseType = Clusters::AccessControl::Commands::
							ReviewFabricRestrictionsResponse::DecodableType;
					...
					public:
						...
						DataModel::DecodableList<
							Structs::CommissioningAccessRestrictionEntryStruct::DecodableType>
							arl;
				...
				namespace ReviewFabricRestrictionsResponse
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::ReviewFabricRestrictionsResponse::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::AccessControl::Id;
