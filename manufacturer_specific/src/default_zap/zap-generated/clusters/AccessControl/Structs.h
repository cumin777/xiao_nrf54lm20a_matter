			...
			namespace Structs
			{
				namespace AccessRestrictionStruct
				{
					...
					public:
						AccessRestrictionTypeEnum type =
							static_cast<AccessRestrictionTypeEnum>(0);
				...
				namespace CommissioningAccessRestrictionEntryStruct
				{
					...
					public:
						...
						DataModel::List<const Structs::AccessRestrictionStruct::Type>
							restrictions;
					...
					public:
						chip::EndpointId endpoint = static_cast<chip::EndpointId>(0);
						chip::ClusterId cluster = static_cast<chip::ClusterId>(0);
						DataModel::DecodableList<Structs::AccessRestrictionStruct::DecodableType>
							restrictions;
				...
				namespace AccessControlEntryStruct
				{
					...
					public:
						AccessControlEntryPrivilegeEnum privilege =
							static_cast<AccessControlEntryPrivilegeEnum>(0);
						AccessControlEntryAuthModeEnum authMode =
							static_cast<AccessControlEntryAuthModeEnum>(0);
