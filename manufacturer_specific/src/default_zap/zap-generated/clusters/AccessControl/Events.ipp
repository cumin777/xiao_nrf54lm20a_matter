				...
				namespace AccessControlEntryChanged
				{
					CHIP_ERROR Type::Encode(TLV::TLVWriter &aWriter, TLV::Tag aTag) const
					{
						...
						ReturnErrorOnFailure(DataModel::Encode(
							aWriter, TLV::ContextTag(Fields::kAdminNodeID), adminNodeID));
						ReturnErrorOnFailure(DataModel::Encode(
							aWriter, TLV::ContextTag(Fields::kAdminPasscodeID),
							adminPasscodeID));
						ReturnErrorOnFailure(DataModel::Encode(
							aWriter, TLV::ContextTag(Fields::kChangeType), changeType));
						ReturnErrorOnFailure(DataModel::EncodeForRead(
							aWriter, TLV::ContextTag(Fields::kLatestValue),
							GetFabricIndex(), latestValue));
						ReturnErrorOnFailure(DataModel::Encode(
						...
						while (true) {
							...
							if (__context_tag == to_underlying(Fields::kAdminNodeID)) {
								err = DataModel::Decode(reader, adminNodeID);
								   ...
								   to_underlying(Fields::kAdminPasscodeID)) {
								err = DataModel::Decode(reader, adminPasscodeID);
							} else if (__context_tag ==
								   to_underlying(Fields::kChangeType)) {
								err = DataModel::Decode(reader, changeType);
							} else if (__context_tag ==
								   to_underlying(Fields::kLatestValue)) {
				...
				namespace FabricRestrictionReviewUpdate
				{
					CHIP_ERROR Type::Encode(TLV::TLVWriter &aWriter, TLV::Tag aTag) const
					{
						...
						ReturnErrorOnFailure(
							aWriter.StartContainer(aTag, TLV::kTLVType_Structure, outer));
						ReturnErrorOnFailure(DataModel::Encode(
							aWriter, TLV::ContextTag(Fields::kToken), token));
						ReturnErrorOnFailure(DataModel::Encode(
							aWriter, TLV::ContextTag(Fields::kInstruction), instruction));
						ReturnErrorOnFailure(DataModel::Encode(
							aWriter, TLV::ContextTag(Fields::kARLRequestFlowUrl),
							ARLRequestFlowUrl));
						ReturnErrorOnFailure(DataModel::Encode(
							aWriter, TLV::ContextTag(Fields::kFabricIndex), fabricIndex));
						return aWriter.EndContainer(outer);
						...
						while (true) {
							...
							if (__context_tag == to_underlying(Fields::kToken)) {
								err = DataModel::Decode(reader, token);
								   ...
								   to_underlying(Fields::kInstruction)) {
								err = DataModel::Decode(reader, instruction);
							} else if (__context_tag ==
								   to_underlying(Fields::kARLRequestFlowUrl)) {
