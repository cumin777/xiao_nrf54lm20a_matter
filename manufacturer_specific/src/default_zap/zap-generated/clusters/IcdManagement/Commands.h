			...
			namespace Commands
			{
				namespace RegisterClient
				{
					...
					public:
						...
						{
							return Commands::RegisterClient::Id;
						}
						...
						using ResponseType = Clusters::IcdManagement::Commands::
							RegisterClientResponse::DecodableType;
				...
				namespace RegisterClientResponse
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::RegisterClientResponse::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::IcdManagement::Id;
				...
				namespace UnregisterClient
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::UnregisterClient::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::IcdManagement::Id;
				...
				namespace StayActiveRequest
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::StayActiveRequest::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::IcdManagement::Id;
						...
						using ResponseType = Clusters::IcdManagement::Commands::
							StayActiveResponse::DecodableType;
				...
				namespace StayActiveResponse
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::StayActiveResponse::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::IcdManagement::Id;
