			...
			namespace Attributes
			{
				...
				namespace IdleModeDuration
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(IdleModeDuration::Id,
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(ActiveModeDuration::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace ActiveModeDuration
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(ActiveModeThreshold::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace ActiveModeThreshold
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(ClientsSupportedPerFabric::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace ClientsSupportedPerFabric
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(UserActiveModeTriggerHint::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace UserActiveModeTriggerHint
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(UserActiveModeTriggerInstruction::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace UserActiveModeTriggerInstruction
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(MaximumCheckInBackOff::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace MaximumCheckInBackOff
			...
			namespace Commands
			{
				...
				namespace RegisterClient
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(RegisterClient::Id,
				...
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(UnregisterClient::Id,
							       BitFlags<DataModel::CommandQualityFlags>(
								       DataModel::CommandQualityFlags::kFabricScoped),
							       Access::Privilege::kManage);
				} // namespace UnregisterClient
