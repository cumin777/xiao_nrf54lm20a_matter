			...
			namespace Commands
			{
				namespace RegisterClient
				{
					...
					CHIP_ERROR Type::Encode(TLV::TLVWriter &aWriter, TLV::Tag aTag) const
					{
						...
						encoder.Encode(to_underlying(Fields::kMonitoredSubject),
							       monitoredSubject);
						...
						while (true) {
							...
							if (__context_tag == to_underlying(Fields::kCheckInNodeID)) {
								err = DataModel::Decode(reader, checkInNodeID);
								   ...
								   to_underlying(Fields::kMonitoredSubject)) {
								...
								err = DataModel::Decode(reader, verificationKey);
								   ...
								   to_underlying(Fields::kClientType)) {
				...
				namespace StayActiveRequest
				{
					...
					{
						DataModel::WrappedStructEncoder encoder{ aWriter, aTag };
						encoder.Encode(to_underlying(Fields::kStayActiveDuration),
							       stayActiveDuration);
						return encoder.Finalize();
					}
					...
					CHIP_ERROR DecodableType::Decode(TLV::TLVReader &reader)
					{
						...
						while (true) {
							...
							if (__context_tag ==
							    to_underlying(Fields::kStayActiveDuration)) {
				...
				namespace StayActiveResponse
				{
					...
					{
						DataModel::WrappedStructEncoder encoder{ aWriter, aTag };
						encoder.Encode(to_underlying(Fields::kPromisedActiveDuration),
					...
					CHIP_ERROR DecodableType::Decode(TLV::TLVReader &reader)
					{
						...
						while (true) {
							...
							if (__context_tag ==
							    to_underlying(Fields::kPromisedActiveDuration)) {
