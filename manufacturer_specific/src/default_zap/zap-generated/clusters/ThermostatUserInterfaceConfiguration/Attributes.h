	...
	namespace Clusters
	{
		namespace ThermostatUserInterfaceConfiguration
		{
			namespace Attributes
			{
				...
				{
					struct TypeInfo {
						using Type = chip::app::Clusters::ThermostatUserInterfaceConfiguration::
						...
						{
							return Clusters::ThermostatUserInterfaceConfiguration::Id;
						}
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::TemperatureDisplayMode::Id;
						}
				...
				namespace KeypadLockout
				{
					struct TypeInfo {
						...
						using DecodableType = chip::app::Clusters::
							ThermostatUserInterfaceConfiguration::KeypadLockoutEnum;
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::KeypadLockout::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace KeypadLockout
				namespace ScheduleProgrammingVisibility
				{
					struct TypeInfo {
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::ScheduleProgrammingVisibility::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace ScheduleProgrammingVisibility
				...
				struct TypeInfo {
					struct DecodableType {
						...
						Attributes::TemperatureDisplayMode::TypeInfo::DecodableType
							temperatureDisplayMode = static_cast<
								chip::app::Clusters::ThermostatUserInterfaceConfiguration::
									TemperatureDisplayModeEnum>(0);
						Attributes::KeypadLockout::TypeInfo::DecodableType keypadLockout =
							static_cast<
								chip::app::Clusters::ThermostatUserInterfaceConfiguration::
									KeypadLockoutEnum>(0);
						Attributes::ScheduleProgrammingVisibility::TypeInfo::DecodableType
							scheduleProgrammingVisibility = static_cast<
								chip::app::Clusters::ThermostatUserInterfaceConfiguration::
									ScheduleProgrammingVisibilityEnum>(0);
