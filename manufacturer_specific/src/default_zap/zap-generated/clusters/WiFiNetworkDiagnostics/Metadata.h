			...
			namespace Attributes
			{
				...
				namespace Bssid
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(Bssid::Id, BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace Bssid
				namespace SecurityType
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(SecurityType::Id,
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(ChannelNumber::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace ChannelNumber
				namespace Rssi
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(Rssi::Id, BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace Rssi
				namespace BeaconLostCount
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(BeaconLostCount::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace BeaconLostCount
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(BeaconRxCount::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace BeaconRxCount
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(PacketMulticastRxCount::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace PacketMulticastRxCount
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(PacketMulticastTxCount::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace PacketMulticastTxCount
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(PacketUnicastRxCount::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace PacketUnicastRxCount
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(PacketUnicastTxCount::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace PacketUnicastTxCount
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(CurrentMaxRate::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace CurrentMaxRate
