			...
			namespace Events
			{
				namespace Disconnection
				{
					...
					public:
						...
						{
							return Events::Disconnection::Id;
						}
				...
				namespace AssociationFailure
				{
					...
					public:
						...
						static constexpr EventId GetEventId()
						{
							return Events::AssociationFailure::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::WiFiNetworkDiagnostics::Id;
						...
						AssociationFailureCauseEnum associationFailureCause =
							static_cast<AssociationFailureCauseEnum>(0);
