			...
			namespace Attributes
			{
				...
				namespace DeviceDirectory
				{
					struct TypeInfo {
						using Type = chip::app::DataModel::List<
							const chip::app::Clusters::EcosystemInformation::Structs::
								EcosystemDeviceStruct::Type>;
						using DecodableType = chip::app::DataModel::DecodableList<
							chip::app::Clusters::EcosystemInformation::Structs::
								EcosystemDeviceStruct::DecodableType>;
						...
						{
							return Clusters::EcosystemInformation::Id;
						}
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::DeviceDirectory::Id;
						}
				...
				namespace LocationDirectory
				{
					struct TypeInfo {
						...
						using DecodableType = chip::app::DataModel::DecodableList<
							chip::app::Clusters::EcosystemInformation::Structs::
								EcosystemLocationStruct::DecodableType>;
						using DecodableArgType = const chip::app::DataModel::DecodableList<
							chip::app::Clusters::EcosystemInformation::Structs::
								EcosystemLocationStruct::DecodableType> &;
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::LocationDirectory::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace LocationDirectory
