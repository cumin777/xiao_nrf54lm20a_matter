				...
				namespace DoorLockAlarm
				{
					CHIP_ERROR Type::Encode(TLV::TLVWriter &aWriter, TLV::Tag aTag) const
					{
						...
						ReturnErrorOnFailure(DataModel::Encode(
							aWriter, TLV::ContextTag(Fields::kAlarmCode), alarmCode));
				...
				namespace DoorStateChange
				{
					CHIP_ERROR Type::Encode(TLV::TLVWriter &aWriter, TLV::Tag aTag) const
					{
						...
						ReturnErrorOnFailure(
							aWriter.StartContainer(aTag, TLV::kTLVType_Structure, outer));
						ReturnErrorOnFailure(DataModel::Encode(
							aWriter, TLV::ContextTag(Fields::kDoorState), doorState));
						return aWriter.EndContainer(outer);
					}
				...
				namespace LockOperation
				{
					CHIP_ERROR Type::Encode(TLV::TLVWriter &aWriter, TLV::Tag aTag) const
					{
						...
						ReturnErrorOnFailure(
							aWriter.StartContainer(aTag, TLV::kTLVType_Structure, outer));
						ReturnErrorOnFailure(DataModel::Encode(
							aWriter, TLV::ContextTag(Fields::kLockOperationType),
							lockOperationType));
						ReturnErrorOnFailure(DataModel::Encode(
							aWriter, TLV::ContextTag(Fields::kOperationSource),
							operationSource));
						ReturnErrorOnFailure(DataModel::Encode(
							aWriter, TLV::ContextTag(Fields::kUserIndex), userIndex));
						ReturnErrorOnFailure(DataModel::Encode(
							aWriter, TLV::ContextTag(Fields::kFabricIndex), fabricIndex));
						ReturnErrorOnFailure(DataModel::Encode(
							aWriter, TLV::ContextTag(Fields::kSourceNode), sourceNode));
						ReturnErrorOnFailure(DataModel::Encode(
							aWriter, TLV::ContextTag(Fields::kCredentials), credentials));
						return aWriter.EndContainer(outer);
					}
					...
					CHIP_ERROR DecodableType::Decode(TLV::TLVReader &reader)
					{
						...
						while (true) {
							...
							if (__context_tag ==
							    to_underlying(Fields::kLockOperationType)) {
								err = DataModel::Decode(reader, lockOperationType);
							} else if (__context_tag ==
								   to_underlying(Fields::kOperationSource)) {
								...
								err = DataModel::Decode(reader, fabricIndex);
								   ...
								   to_underlying(Fields::kSourceNode)) {
				...
				namespace LockOperationError
				{
					CHIP_ERROR Type::Encode(TLV::TLVWriter &aWriter, TLV::Tag aTag) const
					{
						...
						ReturnErrorOnFailure(DataModel::Encode(
							...
							operationSource));
						ReturnErrorOnFailure(DataModel::Encode(
							aWriter, TLV::ContextTag(Fields::kOperationError),
							operationError));
						ReturnErrorOnFailure(DataModel::Encode(
							aWriter, TLV::ContextTag(Fields::kUserIndex), userIndex));
						ReturnErrorOnFailure(DataModel::Encode(
						...
						while (true) {
							...
							if (__context_tag ==
								...
								err = DataModel::Decode(reader, operationSource);
								   ...
								   to_underlying(Fields::kOperationError)) {
				...
				namespace LockUserChange
				{
					CHIP_ERROR Type::Encode(TLV::TLVWriter &aWriter, TLV::Tag aTag) const
					{
						...
						ReturnErrorOnFailure(
							aWriter.StartContainer(aTag, TLV::kTLVType_Structure, outer));
						ReturnErrorOnFailure(DataModel::Encode(
							aWriter, TLV::ContextTag(Fields::kLockDataType), lockDataType));
						ReturnErrorOnFailure(DataModel::Encode(
							aWriter, TLV::ContextTag(Fields::kDataOperationType),
							dataOperationType));
						ReturnErrorOnFailure(DataModel::Encode(
							aWriter, TLV::ContextTag(Fields::kOperationSource),
							operationSource));
						...
						ReturnErrorOnFailure(DataModel::Encode(
							aWriter, TLV::ContextTag(Fields::kSourceNode), sourceNode));
						ReturnErrorOnFailure(DataModel::Encode(
							aWriter, TLV::ContextTag(Fields::kDataIndex), dataIndex));
						return aWriter.EndContainer(outer);
					}
						...
						while (true) {
							...
							if (__context_tag == to_underlying(Fields::kLockDataType)) {
								err = DataModel::Decode(reader, lockDataType);
								   ...
								   to_underlying(Fields::kDataOperationType)) {
