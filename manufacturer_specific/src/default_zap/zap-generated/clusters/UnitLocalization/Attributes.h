			...
			namespace Attributes
			{
				...
				namespace TemperatureUnit
				{
					struct TypeInfo {
						...
						using DecodableType =
							chip::app::Clusters::UnitLocalization::TempUnitEnum;
						using DecodableArgType =
							chip::app::Clusters::UnitLocalization::TempUnitEnum;

						static constexpr ClusterId GetClusterId()
						{
							return Clusters::UnitLocalization::Id;
						}
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::TemperatureUnit::Id;
						}
				...
				namespace SupportedTemperatureUnits
				{
					struct TypeInfo {
						using Type = chip::app::DataModel::List<
							const chip::app::Clusters::UnitLocalization::TempUnitEnum>;
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::SupportedTemperatureUnits::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace SupportedTemperatureUnits
				...
				struct TypeInfo {
					struct DecodableType {
						...
						Attributes::TemperatureUnit::TypeInfo::DecodableType temperatureUnit =
							static_cast<chip::app::Clusters::UnitLocalization::TempUnitEnum>(
								0);
						Attributes::SupportedTemperatureUnits::TypeInfo::DecodableType
