			...
			namespace Commands
			{
				namespace AnnounceOTAProvider
				{
					...
					CHIP_ERROR Type::Encode(TLV::TLVWriter &aWriter, TLV::Tag aTag) const
					{
						...
						encoder.Encode(to_underlying(Fields::kAnnouncementReason),
							       announcementReason);
						encoder.Encode(to_underlying(Fields::kMetadataForNode),
							       metadataForNode);
						...
						while (true) {
							...
							if (__context_tag == to_underlying(Fields::kProviderNodeID)) {
								...
								err = DataModel::Decode(reader, vendorID);
								   ...
								   to_underlying(Fields::kAnnouncementReason)) {
								err = DataModel::Decode(reader, announcementReason);
							} else if (__context_tag ==
								   to_underlying(Fields::kMetadataForNode)) {
