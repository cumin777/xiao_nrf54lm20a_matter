				...
				namespace StateTransition
				{
					CHIP_ERROR Type::Encode(TLV::TLVWriter &aWriter, TLV::Tag aTag) const
					{
						...
						ReturnErrorOnFailure(DataModel::Encode(
							aWriter, TLV::ContextTag(Fields::kPreviousState),
							previousState));
						ReturnErrorOnFailure(DataModel::Encode(
							aWriter, TLV::ContextTag(Fields::kNewState), newState));
						ReturnErrorOnFailure(DataModel::Encode(
							aWriter, TLV::ContextTag(Fields::kReason), reason));
						ReturnErrorOnFailure(DataModel::Encode(
							aWriter, TLV::ContextTag(Fields::kTargetSoftwareVersion),
						...
						while (true) {
							...
							if (__context_tag == to_underlying(Fields::kPreviousState)) {
								...
								err = DataModel::Decode(reader, reason);
								   ...
								   to_underlying(Fields::kTargetSoftwareVersion)) {
				...
				namespace VersionApplied
				{
					CHIP_ERROR Type::Encode(TLV::TLVWriter &aWriter, TLV::Tag aTag) const
					{
						...
						ReturnErrorOnFailure(DataModel::Encode(
							...
							softwareVersion));
						ReturnErrorOnFailure(DataModel::Encode(
							aWriter, TLV::ContextTag(Fields::kProductID), productID));
						return aWriter.EndContainer(outer);
					}
				...
				namespace DownloadError
				{
					CHIP_ERROR Type::Encode(TLV::TLVWriter &aWriter, TLV::Tag aTag) const
					{
						...
						ReturnErrorOnFailure(DataModel::Encode(
							...
							softwareVersion));
						ReturnErrorOnFailure(DataModel::Encode(
							aWriter, TLV::ContextTag(Fields::kBytesDownloaded),
							bytesDownloaded));
						ReturnErrorOnFailure(DataModel::Encode(
							aWriter, TLV::ContextTag(Fields::kProgressPercent),
							progressPercent));
						ReturnErrorOnFailure(DataModel::Encode(
							aWriter, TLV::ContextTag(Fields::kPlatformCode), platformCode));
						return aWriter.EndContainer(outer);
					}
						...
						while (true) {
							...
							if (__context_tag == to_underlying(Fields::kSoftwareVersion)) {
								err = DataModel::Decode(reader, softwareVersion);
								   ...
								   to_underlying(Fields::kBytesDownloaded)) {
								err = DataModel::Decode(reader, bytesDownloaded);
							} else if (__context_tag ==
								   to_underlying(Fields::kProgressPercent)) {
								err = DataModel::Decode(reader, progressPercent);
							} else if (__context_tag ==
								   to_underlying(Fields::kPlatformCode)) {
