		...
		namespace OccupancySensing
		{
			namespace Attributes
			{
									   ...
									   const ConcreteAttributePath &path)
				{
					...
					case Attributes::UltrasonicUnoccupiedToOccupiedThreshold::TypeInfo::
						GetAttributeId():
						return DataModel::Decode(reader,
									 ultrasonicUnoccupiedToOccupiedThreshold);
					case Attributes::PhysicalContactOccupiedToUnoccupiedDelay::TypeInfo::
						GetAttributeId():
						return DataModel::Decode(reader,
									 physicalContactOccupiedToUnoccupiedDelay);
					case Attributes::PhysicalContactUnoccupiedToOccupiedDelay::TypeInfo::
						GetAttributeId():
						return DataModel::Decode(reader,
									 physicalContactUnoccupiedToOccupiedDelay);
					case Attributes::PhysicalContactUnoccupiedToOccupiedThreshold::TypeInfo::
						GetAttributeId():
						return DataModel::Decode(reader,
