			...
			namespace Commands
			{
				namespace AddScene
				{
					...
					public:
						...
						{
							return Commands::AddScene::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::ScenesManagement::Id;
						}
						...
						DataModel::List<const Structs::ExtensionFieldSetStruct::Type>
							extensionFieldSetStructs;

						CHIP_ERROR Encode(TLV::TLVWriter &aWriter, TLV::Tag aTag) const;

						using ResponseType = Clusters::ScenesManagement::Commands::
							AddSceneResponse::DecodableType;
					...
					public:
						...
						uint32_t transitionTime = static_cast<uint32_t>(0);
						chip::CharSpan sceneName;
						DataModel::DecodableList<Structs::ExtensionFieldSetStruct::DecodableType>
							extensionFieldSetStructs;
				...
				namespace AddSceneResponse
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::AddSceneResponse::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::ScenesManagement::Id;
				...
				namespace ViewScene
				{
					...
					public:
						...
						using ResponseType = Clusters::ScenesManagement::Commands::
							ViewSceneResponse::DecodableType;
				...
				namespace ViewSceneResponse
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::ViewSceneResponse::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::ScenesManagement::Id;
						...
						Optional<DataModel::List<const Structs::ExtensionFieldSetStruct::Type>>
							extensionFieldSetStructs;
					...
					public:
						...
						Optional<DataModel::DecodableList<
							Structs::ExtensionFieldSetStruct::DecodableType>>
							extensionFieldSetStructs;
				...
				namespace RemoveScene
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::RemoveScene::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::ScenesManagement::Id;
						...
						using ResponseType = Clusters::ScenesManagement::Commands::
							RemoveSceneResponse::DecodableType;
				...
				namespace RemoveSceneResponse
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::RemoveSceneResponse::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::ScenesManagement::Id;
				...
				namespace RemoveAllScenes
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::RemoveAllScenes::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::ScenesManagement::Id;
						...
						using ResponseType = Clusters::ScenesManagement::Commands::
							RemoveAllScenesResponse::DecodableType;
				...
				namespace RemoveAllScenesResponse
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::RemoveAllScenesResponse::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::ScenesManagement::Id;
				...
				namespace StoreScene
				{
					...
					public:
						...
						using ResponseType = Clusters::ScenesManagement::Commands::
							StoreSceneResponse::DecodableType;
				...
				namespace StoreSceneResponse
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::StoreSceneResponse::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::ScenesManagement::Id;
				...
				namespace RecallScene
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::RecallScene::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::ScenesManagement::Id;
				...
				namespace GetSceneMembership
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::GetSceneMembership::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::ScenesManagement::Id;
						...
						using ResponseType = Clusters::ScenesManagement::Commands::
							GetSceneMembershipResponse::DecodableType;
				...
				namespace GetSceneMembershipResponse
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::GetSceneMembershipResponse::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::ScenesManagement::Id;
				...
				namespace CopyScene
				{
					...
					public:
						...
						chip::BitMask<CopyModeBitmap> mode =
							static_cast<chip::BitMask<CopyModeBitmap>>(0);
						...
						using ResponseType = Clusters::ScenesManagement::Commands::
							CopySceneResponse::DecodableType;
				...
				namespace CopySceneResponse
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::CopySceneResponse::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::ScenesManagement::Id;
