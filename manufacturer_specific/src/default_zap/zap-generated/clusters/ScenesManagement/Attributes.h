			...
			namespace Attributes
			{
				...
				namespace SceneTableSize
				{
					struct TypeInfo {
						...
						{
							return Attributes::SceneTableSize::Id;
						}
				...
				namespace FabricSceneInfo
				{
					struct TypeInfo {
						using Type = chip::app::DataModel::List<
							const chip::app::Clusters::ScenesManagement::Structs::
								SceneInfoStruct::Type>;
						using DecodableType = chip::app::DataModel::DecodableList<
							chip::app::Clusters::ScenesManagement::Structs::
								SceneInfoStruct::DecodableType>;
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::FabricSceneInfo::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace FabricSceneInfo
				...
				struct TypeInfo {
					struct DecodableType {
						...
						Attributes::SceneTableSize::TypeInfo::DecodableType sceneTableSize =
