			...
			namespace Structs
			{
				...
				namespace AttributeValuePairStruct
				{
					CHIP_ERROR Type::Encode(TLV::TLVWriter &aWriter, TLV::Tag aTag) const
					{
						...
						encoder.Encode(to_underlying(Fields::kValueUnsigned16),
							       valueUnsigned16);
						encoder.Encode(to_underlying(Fields::kValueSigned16), valueSigned16);
						encoder.Encode(to_underlying(Fields::kValueUnsigned32),
							       valueUnsigned32);
						encoder.Encode(to_underlying(Fields::kValueSigned32), valueSigned32);
						encoder.Encode(to_underlying(Fields::kValueUnsigned64),
							       valueUnsigned64);
				...
				namespace ExtensionFieldSetStruct
				{
					CHIP_ERROR Type::Encode(TLV::TLVWriter &aWriter, TLV::Tag aTag) const
					{
						...
						encoder.Encode(to_underlying(Fields::kAttributeValueList),
							       attributeValueList);
						return encoder.Finalize();
					}
						...
						while (true) {
							...
							if (__context_tag == to_underlying(Fields::kClusterID)) {
								err = DataModel::Decode(reader, clusterID);
								   ...
								   to_underlying(Fields::kAttributeValueList)) {
				...
				namespace SceneInfoStruct
				{
						       ...
						       const Optional<FabricIndex> &aAccessingFabricIndex) const
					{
						...
						if (includeSensitive) {
							encoder.Encode(to_underlying(Fields::kCurrentScene),
								       currentScene);
						}
						if (includeSensitive) {
							encoder.Encode(to_underlying(Fields::kCurrentGroup),
								       currentGroup);
						}
						if (includeSensitive) {
							encoder.Encode(to_underlying(Fields::kSceneValid), sceneValid);
						}
						encoder.Encode(to_underlying(Fields::kRemainingCapacity),
							       remainingCapacity);
						...
						while (true) {
							...
							if (__context_tag == to_underlying(Fields::kSceneCount)) {
								err = DataModel::Decode(reader, sceneCount);
								   ...
								   to_underlying(Fields::kCurrentScene)) {
								err = DataModel::Decode(reader, currentScene);
							} else if (__context_tag ==
								   to_underlying(Fields::kCurrentGroup)) {
								err = DataModel::Decode(reader, currentGroup);
							} else if (__context_tag ==
								   to_underlying(Fields::kSceneValid)) {
								err = DataModel::Decode(reader, sceneValid);
							} else if (__context_tag ==
								   to_underlying(Fields::kRemainingCapacity)) {
