		...
		namespace DeviceEnergyManagement
		{
			namespace Commands
			{
				...
				namespace StartTimeAdjustRequest
				{
					...
					{
						DataModel::WrappedStructEncoder encoder{ aWriter, aTag };
						encoder.Encode(to_underlying(Fields::kRequestedStartTime),
							       requestedStartTime);
						encoder.Encode(to_underlying(Fields::kCause), cause);
						return encoder.Finalize();
					}
					...
					CHIP_ERROR DecodableType::Decode(TLV::TLVReader &reader)
					{
						...
						while (true) {
							...
							if (__context_tag ==
							    to_underlying(Fields::kRequestedStartTime)) {
				...
				namespace ModifyForecastRequest
				{
					...
					CHIP_ERROR Type::Encode(TLV::TLVWriter &aWriter, TLV::Tag aTag) const
					{
						...
						encoder.Encode(to_underlying(Fields::kSlotAdjustments),
							       slotAdjustments);
						encoder.Encode(to_underlying(Fields::kCause), cause);
						return encoder.Finalize();
					}
						...
						while (true) {
							...
							if (__context_tag == to_underlying(Fields::kForecastID)) {
								err = DataModel::Decode(reader, forecastID);
								   ...
								   to_underlying(Fields::kSlotAdjustments)) {
