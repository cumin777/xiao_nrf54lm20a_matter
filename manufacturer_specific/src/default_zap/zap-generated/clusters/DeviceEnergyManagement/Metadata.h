	...
	namespace Clusters
	{
		namespace DeviceEnergyManagement
		{
			...
			namespace Attributes
			{
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(ESACanGenerate::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace ESACanGenerate
				namespace ESAState
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(PowerAdjustmentCapability::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace PowerAdjustmentCapability
				namespace Forecast
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(OptOutState::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace OptOutState
				constexpr std::array<DataModel::AttributeEntry, 5> kMandatoryMetadata = {
					ESAType::kMetadataEntry,     ESACanGenerate::kMetadataEntry,
					ESAState::kMetadataEntry,    AbsMinPower::kMetadataEntry,
			...
			namespace Commands
			{
				...
				namespace PowerAdjustRequest
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(PowerAdjustRequest::Id,
				...
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(CancelPowerAdjustRequest::Id,
							       BitFlags<DataModel::CommandQualityFlags>(),
							       Access::Privilege::kOperate);
				} // namespace CancelPowerAdjustRequest
				...
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(StartTimeAdjustRequest::Id,
							       BitFlags<DataModel::CommandQualityFlags>(),
							       Access::Privilege::kOperate);
				} // namespace StartTimeAdjustRequest
				...
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(PauseRequest::Id,
							       BitFlags<DataModel::CommandQualityFlags>(),
							       Access::Privilege::kOperate);
				} // namespace PauseRequest
				...
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(ResumeRequest::Id,
							       BitFlags<DataModel::CommandQualityFlags>(),
							       Access::Privilege::kOperate);
				} // namespace ResumeRequest
				...
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(ModifyForecastRequest::Id,
							       BitFlags<DataModel::CommandQualityFlags>(),
							       Access::Privilege::kOperate);
				} // namespace ModifyForecastRequest
				...
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(RequestConstraintBasedForecast::Id,
							       BitFlags<DataModel::CommandQualityFlags>(),
							       Access::Privilege::kOperate);
				} // namespace RequestConstraintBasedForecast
				...
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(CancelRequest::Id,
							       BitFlags<DataModel::CommandQualityFlags>(),
							       Access::Privilege::kOperate);
				} // namespace CancelRequest
