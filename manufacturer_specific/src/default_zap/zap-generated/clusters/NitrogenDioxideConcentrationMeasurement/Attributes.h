			...
			namespace Attributes
			{
				...
				namespace MeasuredValue
				{
					struct TypeInfo {
						...
						{
							return Clusters::NitrogenDioxideConcentrationMeasurement::Id;
						}
				...
				namespace MeasurementUnit
				{
					struct TypeInfo {
						using Type = chip::app::Clusters::
							NitrogenDioxideConcentrationMeasurement::MeasurementUnitEnum;
				...
				namespace MeasurementMedium
				{
					struct TypeInfo {
						using Type = chip::app::Clusters::
							NitrogenDioxideConcentrationMeasurement::MeasurementMediumEnum;
						using DecodableType = chip::app::Clusters::
							NitrogenDioxideConcentrationMeasurement::MeasurementMediumEnum;
						using DecodableArgType = chip::app::Clusters::
							NitrogenDioxideConcentrationMeasurement::MeasurementMediumEnum;
				...
				namespace LevelValue
				{
					struct TypeInfo {
						using Type = chip::app::Clusters::
							NitrogenDioxideConcentrationMeasurement::LevelValueEnum;
						using DecodableType = chip::app::Clusters::
							NitrogenDioxideConcentrationMeasurement::LevelValueEnum;
						using DecodableArgType = chip::app::Clusters::
							NitrogenDioxideConcentrationMeasurement::LevelValueEnum;
				...
				struct TypeInfo {
					struct DecodableType {
						...
						Attributes::LevelValue::TypeInfo::DecodableType levelValue = static_cast<
							chip::app::Clusters::NitrogenDioxideConcentrationMeasurement::
								LevelValueEnum>(0);
