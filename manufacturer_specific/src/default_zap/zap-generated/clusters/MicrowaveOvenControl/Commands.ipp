			...
			namespace Commands
			{
				namespace SetCookingParameters
				{
					...
					CHIP_ERROR Type::Encode(TLV::TLVWriter &aWriter, TLV::Tag aTag) const
					{
						...
						encoder.Encode(to_underlying(Fields::kWattSettingIndex),
							       wattSettingIndex);
						encoder.Encode(to_underlying(Fields::kStartAfterSetting),
							       startAfterSetting);
						...
						while (true) {
							...
							if (__context_tag == to_underlying(Fields::kCookMode)) {
								...
								err = DataModel::Decode(reader, cookTime);
								   ...
								   to_underlying(Fields::kPowerSetting)) {
								err = DataModel::Decode(reader, powerSetting);
							} else if (__context_tag ==
								   to_underlying(Fields::kWattSettingIndex)) {
								err = DataModel::Decode(reader, wattSettingIndex);
							} else if (__context_tag ==
								   to_underlying(Fields::kStartAfterSetting)) {
