			...
			namespace Attributes
			{
				...
				namespace CookTime
				{
					struct TypeInfo {
						...
						{
							return Clusters::MicrowaveOvenControl::Id;
						}
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::CookTime::Id;
						}
				...
				namespace MaxCookTime
				{
					struct TypeInfo {
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::MaxCookTime::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace MaxCookTime
				namespace PowerSetting
				{
					struct TypeInfo {
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::PowerSetting::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace PowerSetting
				...
				namespace PowerStep
				{
					struct TypeInfo {
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::PowerStep::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace PowerStep
				namespace SupportedWatts
				{
					struct TypeInfo {
						...
						using DecodableArgType =
							const chip::app::DataModel::DecodableList<uint16_t> &;
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::SupportedWatts::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace SupportedWatts
				namespace SelectedWattIndex
				{
					struct TypeInfo {
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::SelectedWattIndex::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace SelectedWattIndex
				namespace WattRating
				{
					struct TypeInfo {
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::WattRating::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace WattRating
				...
				struct TypeInfo {
					struct DecodableType {
						...
						Attributes::CookTime::TypeInfo::DecodableType cookTime =
							static_cast<uint32_t>(0);
						Attributes::MaxCookTime::TypeInfo::DecodableType maxCookTime =
							static_cast<uint32_t>(0);
						Attributes::PowerSetting::TypeInfo::DecodableType powerSetting =
							static_cast<uint8_t>(0);
						Attributes::MinPower::TypeInfo::DecodableType minPower =
							static_cast<uint8_t>(0);
						Attributes::MaxPower::TypeInfo::DecodableType maxPower =
							static_cast<uint8_t>(0);
						Attributes::PowerStep::TypeInfo::DecodableType powerStep =
							static_cast<uint8_t>(0);
						Attributes::SupportedWatts::TypeInfo::DecodableType supportedWatts;
						Attributes::SelectedWattIndex::TypeInfo::DecodableType
							selectedWattIndex = static_cast<uint8_t>(0);
