			...
			namespace Commands
			{
				namespace NetworkPassphraseRequest
				{
					...
					public:
						...
						{
							return Commands::NetworkPassphraseRequest::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::WiFiNetworkManagement::Id;
						}

						CHIP_ERROR Encode(TLV::TLVWriter &aWriter, TLV::Tag aTag) const;

						using ResponseType = Clusters::WiFiNetworkManagement::Commands::
							NetworkPassphraseResponse::DecodableType;
				...
				namespace NetworkPassphraseResponse
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::NetworkPassphraseResponse::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::WiFiNetworkManagement::Id;
