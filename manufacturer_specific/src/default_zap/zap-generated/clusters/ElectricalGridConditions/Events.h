			...
			namespace Events
			{
				namespace CurrentConditionsChanged
				{
					...
					public:
						...
						{
							return Events::CurrentConditionsChanged::Id;
						}
						...
						DataModel::Nullable<Structs::ElectricalGridConditionsStruct::Type>
							currentConditions;
					...
					public:
						...
						DataModel::Nullable<
							Structs::ElectricalGridConditionsStruct::DecodableType>
							currentConditions;
