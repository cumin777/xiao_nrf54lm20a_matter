			...
			namespace Attributes
			{
				...
				namespace LocalGenerationAvailable
				{
					struct TypeInfo {
						...
						{
							return Clusters::ElectricalGridConditions::Id;
						}
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::LocalGenerationAvailable::Id;
						}
				...
				namespace CurrentConditions
				{
					struct TypeInfo {
						using Type = chip::app::DataModel::Nullable<
							chip::app::Clusters::ElectricalGridConditions::Structs::
								ElectricalGridConditionsStruct::Type>;
						using DecodableType = chip::app::DataModel::Nullable<
							chip::app::Clusters::ElectricalGridConditions::Structs::
								ElectricalGridConditionsStruct::DecodableType>;
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::CurrentConditions::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace CurrentConditions
				namespace ForecastConditions
				{
					struct TypeInfo {
						using Type = chip::app::DataModel::List<
							const chip::app::Clusters::ElectricalGridConditions::Structs::
								ElectricalGridConditionsStruct::Type>;
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::ForecastConditions::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace ForecastConditions
				...
				struct TypeInfo {
					struct DecodableType {
						...
						Attributes::LocalGenerationAvailable::TypeInfo::DecodableType
							localGenerationAvailable;
						Attributes::CurrentConditions::TypeInfo::DecodableType currentConditions;
						Attributes::ForecastConditions::TypeInfo::DecodableType
							forecastConditions;
