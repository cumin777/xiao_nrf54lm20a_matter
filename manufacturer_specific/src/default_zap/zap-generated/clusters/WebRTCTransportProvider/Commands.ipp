			...
			namespace Commands
			{
				namespace SolicitOffer
				{
					...
					CHIP_ERROR Type::Encode(TLV::TLVWriter &aWriter, TLV::Tag aTag) const
					{
						...
						encoder.Encode(to_underlying(Fields::kOriginatingEndpointID),
						...
						encoder.Encode(to_underlying(Fields::kICETransportPolicy),
							       ICETransportPolicy);
						...
						while (true) {
							...
							if (__context_tag == to_underlying(Fields::kStreamUsage)) {
								err = DataModel::Decode(reader, streamUsage);
								   ...
								   to_underlying(Fields::kOriginatingEndpointID)) {
								...
								err = DataModel::Decode(reader, audioStreamID);
								   ...
								   to_underlying(Fields::kICEServers)) {
								err = DataModel::Decode(reader, ICEServers);
							} else if (__context_tag ==
								   to_underlying(Fields::kICETransportPolicy)) {
				...
				namespace SolicitOfferResponse
				{
					...
					{
						DataModel::WrappedStructEncoder encoder{ aWriter, aTag };
						encoder.Encode(to_underlying(Fields::kWebRTCSessionID),
							       webRTCSessionID);
						...
						while (true) {
							...
							if (__context_tag == to_underlying(Fields::kWebRTCSessionID)) {
								err = DataModel::Decode(reader, webRTCSessionID);
								   ...
								   to_underlying(Fields::kDeferredOffer)) {
						...
						while (true) {
							...
							if (__context_tag == to_underlying(Fields::kWebRTCSessionID)) {
								err = DataModel::Decode(reader, webRTCSessionID);
								   ...
								   to_underlying(Fields::kICECandidates)) {
