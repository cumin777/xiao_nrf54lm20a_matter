			...
			namespace Commands
			{
				...
				namespace GetOperationalDataset
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::GetOperationalDataset::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::ThreadNetworkDirectory::Id;
						...
						using ResponseType = Clusters::ThreadNetworkDirectory::Commands::
							OperationalDatasetResponse::DecodableType;
				...
				namespace OperationalDatasetResponse
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::OperationalDatasetResponse::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::ThreadNetworkDirectory::Id;
