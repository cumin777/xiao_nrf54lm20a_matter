			...
			namespace Attributes
			{
				...
				namespace PreferredExtendedPanID
				{
					struct TypeInfo {
						...
						{
							return Clusters::ThreadNetworkDirectory::Id;
						}
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::PreferredExtendedPanID::Id;
						}
				...
				namespace ThreadNetworks
				{
					struct TypeInfo {
						using Type = chip::app::DataModel::List<
							const chip::app::Clusters::ThreadNetworkDirectory::Structs::
								ThreadNetworkStruct::Type>;
						using DecodableType = chip::app::DataModel::DecodableList<
							chip::app::Clusters::ThreadNetworkDirectory::Structs::
								ThreadNetworkStruct::DecodableType>;
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::ThreadNetworks::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace ThreadNetworks
				namespace ThreadNetworkTableSize
				{
					struct TypeInfo {
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::ThreadNetworkTableSize::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace ThreadNetworkTableSize
				...
				struct TypeInfo {
					struct DecodableType {
						...
						Attributes::PreferredExtendedPanID::TypeInfo::DecodableType
							preferredExtendedPanID;
						Attributes::ThreadNetworks::TypeInfo::DecodableType threadNetworks;
						Attributes::ThreadNetworkTableSize::TypeInfo::DecodableType
							threadNetworkTableSize = static_cast<uint8_t>(0);
