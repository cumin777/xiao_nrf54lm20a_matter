			...
			namespace Structs
			{
				...
				namespace ThreadInterfaceScanResultStruct
				{
					CHIP_ERROR Type::Encode(TLV::TLVWriter &aWriter, TLV::Tag aTag) const
					{
						...
						encoder.Encode(to_underlying(Fields::kExtendedAddress),
							       extendedAddress);
						...
						while (true) {
							...
							if (__context_tag == to_underlying(Fields::kPanId)) {
								err = DataModel::Decode(reader, panId);
								   ...
								   to_underlying(Fields::kExtendedPanId)) {
								err = DataModel::Decode(reader, extendedPanId);
							} else if (__context_tag ==
								   to_underlying(Fields::kNetworkName)) {
								...
								err = DataModel::Decode(reader, version);
								   ...
								   to_underlying(Fields::kExtendedAddress)) {
