			...
			namespace Attributes
			{
				...
				namespace MaxRootCertificates
				{
					struct TypeInfo {
						...
						{
							return Attributes::MaxRootCertificates::Id;
						}
				...
				namespace ProvisionedRootCertificates
				{
					struct TypeInfo {
						using Type = chip::app::DataModel::List<
							const chip::app::Clusters::TlsCertificateManagement::Structs::
								TLSCertStruct::Type>;
						using DecodableType = chip::app::DataModel::DecodableList<
							chip::app::Clusters::TlsCertificateManagement::Structs::
								TLSCertStruct::DecodableType>;
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::ProvisionedRootCertificates::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace ProvisionedRootCertificates
				namespace MaxClientCertificates
				{
					struct TypeInfo {
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::MaxClientCertificates::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace MaxClientCertificates
				namespace ProvisionedClientCertificates
				{
					struct TypeInfo {
						using Type = chip::app::DataModel::List<
							const chip::app::Clusters::TlsCertificateManagement::Structs::
								TLSClientCertificateDetailStruct::Type>;
						using DecodableType = chip::app::DataModel::DecodableList<
							chip::app::Clusters::TlsCertificateManagement::Structs::
								TLSClientCertificateDetailStruct::DecodableType>;
						using DecodableArgType = const chip::app::DataModel::DecodableList<
							chip::app::Clusters::TlsCertificateManagement::Structs::
								TLSClientCertificateDetailStruct::DecodableType> &;
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::ProvisionedClientCertificates::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace ProvisionedClientCertificates
				...
				struct TypeInfo {
					struct DecodableType {
						...
						Attributes::MaxRootCertificates::TypeInfo::DecodableType
							maxRootCertificates = static_cast<uint8_t>(0);
						Attributes::ProvisionedRootCertificates::TypeInfo::DecodableType
							provisionedRootCertificates;
						Attributes::MaxClientCertificates::TypeInfo::DecodableType
							maxClientCertificates = static_cast<uint8_t>(0);
						Attributes::ProvisionedClientCertificates::TypeInfo::DecodableType
