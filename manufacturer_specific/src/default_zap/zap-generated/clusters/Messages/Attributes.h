		...
		namespace Messages
		{
			namespace Attributes
			{
				...
				namespace Messages
				{
					struct TypeInfo {
						using Type =
							chip::app::DataModel::List<const chip::app::Clusters::Messages::
											   Structs::MessageStruct::Type>;
						using DecodableType = chip::app::DataModel::DecodableList<
							chip::app::Clusters::Messages::Structs::MessageStruct::
								DecodableType>;
				...
				namespace ActiveMessageIDs
				{
					struct TypeInfo {
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::ActiveMessageIDs::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace ActiveMessageIDs
