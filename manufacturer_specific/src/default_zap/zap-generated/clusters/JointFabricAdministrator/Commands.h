			...
			namespace Commands
			{
				namespace ICACCSRRequest
				{
					...
					public:
						...
						{
							return Commands::ICACCSRRequest::Id;
						}
						...
						using ResponseType = Clusters::JointFabricAdministrator::Commands::
							ICACCSRResponse::DecodableType;
				...
				namespace ICACCSRResponse
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::ICACCSRResponse::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::JointFabricAdministrator::Id;
				...
				namespace ICACResponse
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::ICACResponse::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::JointFabricAdministrator::Id;
						...
						ICACResponseStatusEnum statusCode =
							static_cast<ICACResponseStatusEnum>(0);
				...
				namespace OpenJointCommissioningWindow
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::OpenJointCommissioningWindow::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::JointFabricAdministrator::Id;
				...
				namespace TransferAnchorRequest
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::TransferAnchorRequest::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::JointFabricAdministrator::Id;
						...
						using ResponseType = Clusters::JointFabricAdministrator::Commands::
							TransferAnchorResponse::DecodableType;
				...
				namespace TransferAnchorResponse
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::TransferAnchorResponse::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::JointFabricAdministrator::Id;
						...
						TransferAnchorResponseStatusEnum statusCode =
							static_cast<TransferAnchorResponseStatusEnum>(0);
				...
				namespace TransferAnchorComplete
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::TransferAnchorComplete::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::JointFabricAdministrator::Id;
				...
				namespace AnnounceJointFabricAdministrator
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::AnnounceJointFabricAdministrator::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::JointFabricAdministrator::Id;
