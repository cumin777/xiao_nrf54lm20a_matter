			...
			namespace Attributes
			{
				...
				namespace AdministratorFabricIndex
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(AdministratorFabricIndex::Id,
			...
			namespace Commands
			{
				...
				namespace ICACCSRRequest
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(ICACCSRRequest::Id,
				...
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(AddICAC::Id, BitFlags<DataModel::CommandQualityFlags>(),
							       Access::Privilege::kAdminister);
				} // namespace AddICAC
				namespace OpenJointCommissioningWindow
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(OpenJointCommissioningWindow::Id,
							       BitFlags<DataModel::CommandQualityFlags>(),
							       Access::Privilege::kAdminister);
				} // namespace OpenJointCommissioningWindow
				...
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(TransferAnchorRequest::Id,
							       BitFlags<DataModel::CommandQualityFlags>(),
							       Access::Privilege::kAdminister);
				} // namespace TransferAnchorRequest
				...
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(TransferAnchorComplete::Id,
							       BitFlags<DataModel::CommandQualityFlags>(),
							       Access::Privilege::kAdminister);
				} // namespace TransferAnchorComplete
				...
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(AnnounceJointFabricAdministrator::Id,
							       BitFlags<DataModel::CommandQualityFlags>(),
							       Access::Privilege::kAdminister);
				} // namespace AnnounceJointFabricAdministrator
