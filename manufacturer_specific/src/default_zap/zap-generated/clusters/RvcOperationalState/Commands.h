			...
			namespace Commands
			{
				namespace Pause
				{
					...
					public:
						...
						using ResponseType = Clusters::RvcOperationalState::Commands::
							OperationalCommandResponse::DecodableType;
				...
				namespace OperationalCommandResponse
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::OperationalCommandResponse::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::RvcOperationalState::Id;
