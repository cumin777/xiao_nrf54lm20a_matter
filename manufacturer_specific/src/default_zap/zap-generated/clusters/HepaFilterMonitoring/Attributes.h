			...
			namespace Attributes
			{
				...
				namespace Condition
				{
					struct TypeInfo {
						...
						{
							return Clusters::HepaFilterMonitoring::Id;
						}
				...
				{
					struct TypeInfo {
						using Type = chip::app::Clusters::HepaFilterMonitoring::
							DegradationDirectionEnum;
						using DecodableType = chip::app::Clusters::HepaFilterMonitoring::
							DegradationDirectionEnum;
						using DecodableArgType = chip::app::Clusters::HepaFilterMonitoring::
							DegradationDirectionEnum;
				...
				namespace ChangeIndication
				{
					struct TypeInfo {
						using Type =
							chip::app::Clusters::HepaFilterMonitoring::ChangeIndicationEnum;
						using DecodableType =
							chip::app::Clusters::HepaFilterMonitoring::ChangeIndicationEnum;
				...
				namespace ReplacementProductList
				{
					struct TypeInfo {
						using Type = chip::app::DataModel::List<
							const chip::app::Clusters::HepaFilterMonitoring::Structs::
								ReplacementProductStruct::Type>;
						using DecodableType = chip::app::DataModel::DecodableList<
							chip::app::Clusters::HepaFilterMonitoring::Structs::
					...
					struct DecodableType {
						...
						Attributes::DegradationDirection::TypeInfo::DecodableType
							degradationDirection =
								static_cast<chip::app::Clusters::HepaFilterMonitoring::
