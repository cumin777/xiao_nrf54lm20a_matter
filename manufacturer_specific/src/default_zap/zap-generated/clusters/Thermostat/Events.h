			...
			namespace Events
			{
				namespace SystemModeChange
				{
					...
					public:
						...
						{
							return Events::SystemModeChange::Id;
						}
				...
				namespace LocalTemperatureChange
				{
					...
					public:
						...
						static constexpr EventId GetEventId()
						{
							return Events::LocalTemperatureChange::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::Thermostat::Id;
				...
				namespace OccupancyChange
				{
					...
					public:
						...
						static constexpr EventId GetEventId()
						{
							return Events::OccupancyChange::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::Thermostat::Id;
						...
						chip::BitMask<OccupancyBitmap> currentOccupancy =
							static_cast<chip::BitMask<OccupancyBitmap>>(0);
				...
				namespace SetpointChange
				{
					...
					public:
						...
						static constexpr EventId GetEventId()
						{
							return Events::SetpointChange::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::Thermostat::Id;
				...
				namespace RunningStateChange
				{
					...
					public:
						...
						static constexpr EventId GetEventId()
						{
							return Events::RunningStateChange::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::Thermostat::Id;
						...
						chip::BitMask<RelayStateBitmap> currentRunningState =
							static_cast<chip::BitMask<RelayStateBitmap>>(0);
				...
				namespace RunningModeChange
				{
					...
					public:
						...
						static constexpr EventId GetEventId()
						{
							return Events::RunningModeChange::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::Thermostat::Id;
						...
						ThermostatRunningModeEnum currentRunningMode =
							static_cast<ThermostatRunningModeEnum>(0);
				...
				namespace ActiveScheduleChange
				{
					...
					public:
						...
						static constexpr EventId GetEventId()
						{
							return Events::ActiveScheduleChange::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::Thermostat::Id;
				...
				namespace ActivePresetChange
				{
					...
					public:
						...
						static constexpr EventId GetEventId()
						{
							return Events::ActivePresetChange::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::Thermostat::Id;
