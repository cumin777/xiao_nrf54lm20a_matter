		...
		namespace Thermostat
		{
			namespace Structs
			{
				namespace ScheduleTransitionStruct
				{
					...
					struct Type {
					public:
						chip::BitMask<ScheduleDayOfWeekBitmap> dayOfWeek =
				...
				namespace ScheduleStruct
				{
					...
					public:
						...
						Optional<chip::ByteSpan> presetHandle;
						DataModel::List<const Structs::ScheduleTransitionStruct::Type>
							transitions;
					...
					public:
						...
						Optional<chip::CharSpan> name;
						Optional<chip::ByteSpan> presetHandle;
						DataModel::DecodableList<Structs::ScheduleTransitionStruct::DecodableType>
							transitions;
						DataModel::Nullable<bool> builtIn;
				...
				namespace PresetTypeStruct
				{
					...
					public:
						...
						chip::BitMask<PresetTypeFeaturesBitmap> presetTypeFeatures =
							static_cast<chip::BitMask<PresetTypeFeaturesBitmap>>(0);
				...
				namespace ScheduleTypeStruct
				{
					...
					public:
						...
						chip::BitMask<ScheduleTypeFeaturesBitmap> scheduleTypeFeatures =
							static_cast<chip::BitMask<ScheduleTypeFeaturesBitmap>>(0);
