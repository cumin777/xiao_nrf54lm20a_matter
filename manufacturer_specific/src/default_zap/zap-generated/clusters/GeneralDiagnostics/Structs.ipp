			...
			namespace Structs
			{
				...
				namespace NetworkInterface
				{
					CHIP_ERROR Type::Encode(TLV::TLVWriter &aWriter, TLV::Tag aTag) const
					{
						...
						encoder.Encode(to_underlying(Fields::kOffPremiseServicesReachableIPv4),
							       offPremiseServicesReachableIPv4);
						encoder.Encode(to_underlying(Fields::kOffPremiseServicesReachableIPv6),
							       offPremiseServicesReachableIPv6);
						encoder.Encode(to_underlying(Fields::kHardwareAddress),
							       hardwareAddress);
						...
						while (true) {
							...
							if (__context_tag == to_underlying(Fields::kName)) {
								err = DataModel::Decode(reader, name);
								   ...
								   to_underlying(Fields::kIsOperational)) {
								err = DataModel::Decode(reader, isOperational);
							} else if (__context_tag ==
								   to_underlying(
									   Fields::kOffPremiseServicesReachableIPv4)) {
								err = DataModel::Decode(
									reader, offPremiseServicesReachableIPv4);
							} else if (__context_tag ==
								   to_underlying(
									   Fields::kOffPremiseServicesReachableIPv6)) {
								err = DataModel::Decode(
									reader, offPremiseServicesReachableIPv6);
							} else if (__context_tag ==
								   to_underlying(Fields::kHardwareAddress)) {
								err = DataModel::Decode(reader, hardwareAddress);
							} else if (__context_tag ==
								   to_underlying(Fields::kIPv4Addresses)) {
								err = DataModel::Decode(reader, IPv4Addresses);
							} else if (__context_tag ==
								   to_underlying(Fields::kIPv6Addresses)) {
