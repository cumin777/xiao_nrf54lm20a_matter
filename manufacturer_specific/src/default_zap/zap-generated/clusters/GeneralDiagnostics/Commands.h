			...
			namespace Commands
			{
				namespace TestEventTrigger
				{
					...
					public:
						...
						{
							return Commands::TestEventTrigger::Id;
						}
				...
				namespace TimeSnapshot
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::TimeSnapshot::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::GeneralDiagnostics::Id;
						...
						using ResponseType = Clusters::GeneralDiagnostics::Commands::
							TimeSnapshotResponse::DecodableType;
				...
				namespace TimeSnapshotResponse
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::TimeSnapshotResponse::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::GeneralDiagnostics::Id;
				...
				namespace PayloadTestRequest
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::PayloadTestRequest::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::GeneralDiagnostics::Id;
						...
						using ResponseType = Clusters::GeneralDiagnostics::Commands::
							PayloadTestResponse::DecodableType;
				...
				namespace PayloadTestResponse
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::PayloadTestResponse::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::GeneralDiagnostics::Id;
