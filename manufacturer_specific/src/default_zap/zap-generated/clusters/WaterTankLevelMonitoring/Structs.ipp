			...
			namespace Structs
			{
				...
				namespace ReplacementProductStruct
				{
					CHIP_ERROR Type::Encode(TLV::TLVWriter &aWriter, TLV::Tag aTag) const
					{
						...
						encoder.Encode(to_underlying(Fields::kProductIdentifierType),
							       productIdentifierType);
						encoder.Encode(to_underlying(Fields::kProductIdentifierValue),
					...
					CHIP_ERROR DecodableType::Decode(TLV::TLVReader &reader)
					{
						...
						while (true) {
							...
							if (__context_tag ==
							    to_underlying(Fields::kProductIdentifierType)) {
								err = DataModel::Decode(reader, productIdentifierType);
							} else if (__context_tag ==
								   to_underlying(Fields::kProductIdentifierValue)) {
