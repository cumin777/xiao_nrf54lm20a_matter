			...
			namespace Commands
			{
				...
				namespace AddArgumentsResponse
				{
					...
					public:
						...
						{
							return Commands::AddArgumentsResponse::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::SampleMei::Id;
				...
				namespace AddArguments
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::AddArguments::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::SampleMei::Id;
						...
						using ResponseType = Clusters::SampleMei::Commands::
							AddArgumentsResponse::DecodableType;
