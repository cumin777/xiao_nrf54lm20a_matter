			...
			namespace Attributes
			{
				...
				namespace WindowStatus
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(WindowStatus::Id,
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(AdminFabricIndex::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace AdminFabricIndex
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(AdminVendorId::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace AdminVendorId
			...
			namespace Commands
			{
				...
				namespace OpenCommissioningWindow
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(OpenCommissioningWindow::Id,
				...
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(RevokeCommissioning::Id,
							       BitFlags<DataModel::CommandQualityFlags>(
								       DataModel::CommandQualityFlags::kTimed),
							       Access::Privilege::kAdminister);
				} // namespace RevokeCommissioning
