			...
			namespace Attributes
			{
				...
				namespace InstalledChimeSounds
				{
					struct TypeInfo {
						using Type = chip::app::DataModel::List<
							const chip::app::Clusters::Chime::Structs::ChimeSoundStruct::Type>;
						using DecodableType = chip::app::DataModel::DecodableList<
							chip::app::Clusters::Chime::Structs::ChimeSoundStruct::
								DecodableType>;
						...
						{
							return Attributes::InstalledChimeSounds::Id;
						}
				...
				namespace SelectedChime
				{
					struct TypeInfo {
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::SelectedChime::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace SelectedChime
				...
				struct TypeInfo {
					struct DecodableType {
						...
						Attributes::InstalledChimeSounds::TypeInfo::DecodableType
							installedChimeSounds;
						Attributes::SelectedChime::TypeInfo::DecodableType selectedChime =
