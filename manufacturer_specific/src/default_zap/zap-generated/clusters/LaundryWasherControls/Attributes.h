			...
			namespace Attributes
			{
				...
				namespace SpinSpeeds
				{
					struct TypeInfo {
						...
						{
							return Clusters::LaundryWasherControls::Id;
						}
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::SpinSpeeds::Id;
						}
				...
				namespace SpinSpeedCurrent
				{
					struct TypeInfo {
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::SpinSpeedCurrent::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace SpinSpeedCurrent
				namespace NumberOfRinses
				{
					struct TypeInfo {
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::NumberOfRinses::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace NumberOfRinses
				namespace SupportedRinses
				{
					struct TypeInfo {
						using Type = chip::app::DataModel::List<
							const chip::app::Clusters::LaundryWasherControls::
								NumberOfRinsesEnum>;
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::SupportedRinses::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace SupportedRinses
				...
				struct TypeInfo {
					struct DecodableType {
						...
						Attributes::NumberOfRinses::TypeInfo::DecodableType numberOfRinses =
							static_cast<chip::app::Clusters::LaundryWasherControls::
									    NumberOfRinsesEnum>(0);
