...
#define MATTER_DM_NORDIC_DEV_KIT_CLUSTER_CLIENT_ENDPOINT_COUNT (0)
...
#define BASIC_INFORMATION_ENABLE_GENERATE_RANDOM_CMD 1
...
//  NordicDevKit Cluster Commands
#define NORDIC_DEV_KIT_ENABLE_SET_LED_CMD 1
